...
// monadic lift
export function _mlift_while_10071(action, predicate, wild__) /* forall<e> (action : () -> <div|e> (), predicate : () -> <div|e> bool, wild_ : ()) -> <div|e> () */  {
  return $while(predicate, action);
}
 
 
// monadic lift
export function _mlift_while_10072(action_0, predicate_0, _y_x10027) /* forall<e> (action : () -> <div|e> (), predicate : () -> <div|e> bool, bool) -> <div|e> () */  {
  if (_y_x10027) {
     
    var x_10079 = action_0();
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
        return _mlift_while_10071(action_0, predicate_0, wild___0);
      });
    }
    else {
      return _mlift_while_10071(action_0, predicate_0, x_10079);
    }
  }
  else {
    return $std_core_types.Unit;
...
export function $while(predicate_1, action_1) /* forall<e> (predicate : () -> <div|e> bool, action : () -> <div|e> ()) -> <div|e> () */  { tailcall: while(1)
{
  ...
  var x_0_10081 = predicate_1();
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10027_0 /* bool */ ) {
      return _mlift_while_10072(action_1, predicate_1, _y_x10027_0);
    });
  }
  else {
    if (x_0_10081) {
       
      var x_1_10084 = action_1();
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(wild___1 /* () */ ) {
          return _mlift_while_10071(action_1, predicate_1, wild___1);
        });
      }
      else {
        {
...
// monadic lift
export function range_fs__mlift_fold_10073(end, f, start, x) /* forall<a,e> (end : int, f : (int, a) -> e a, start : int, x : a) -> e a */  {
...
export function range_fs_fold(start_0, end_0, init, f_0) /* forall<a,e> (start : int, end : int, init : a, f : (int, a) -> e a) -> e a */  { tailcall: while(1)
{
  if ($std_core_types._int_gt(start_0,end_0)) {
    ...
    var x_0_10087 = f_0(start_0, init);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(x_1 /* 588 */ ) {
        return range_fs__mlift_fold_10073(end_0, f_0, start_0, x_1);
      });
    }
    else {
      {
...
// monadic lift
export function range_fs__mlift_fold_while_10074(end, f, init, start, _y_x10035) /* forall<a,e> (end : int, f : (int, a) -> e maybe<a>, init : a, start : int, maybe<a>) -> e a */  {
  if (_y_x10035 !== null) {
    return range_fs_fold_while($std_core_types._int_add(start,1), end, _y_x10035.value, f);
  }
  else {
    return init;
  }
...
export function range_fs_fold_while(start_0, end_0, init_0, f_0) /* forall<a,e> (start : int, end : int, init : a, f : (int, a) -> e maybe<a>) -> e a */  { tailcall: while(1)
{
  if ($std_core_types._int_gt(start_0,end_0)) {
    ...
    var x_0_10090 = f_0(start_0, init_0);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10035_0 /* maybe<685> */ ) {
        return range_fs__mlift_fold_while_10074(end_0, f_0, init_0, start_0, _y_x10035_0);
      });
    }
    else {
      if (x_0_10090 !== null) {
...
// monadic lift
export function range_fs__mlift_lift_for_1256_10075(action, end, i, wild__) /* forall<e> (action : (int) -> e (), end : int, i : int, wild_ : ()) -> e () */  {
...
export function range_fs__lift_for_1256(action_0, end_0, i_0) /* forall<e> (action : (int) -> e (), end : int, i : int) -> e () */  { tailcall: while(1)
{
  if ($std_core_types._int_le(i_0,end_0)) {
    ...
    var x_10093 = action_0(i_0);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
        return range_fs__mlift_lift_for_1256_10075(action_0, end_0, i_0, wild___0);
      });
    }
    else {
...
// monadic lift
export function range_fs__mlift_lift_for_while_1257_10076(action, end, i, _y_x10047) /* forall<a,e> (action : (int) -> e maybe<a>, end : int, i : int, maybe<a>) -> e maybe<a> */  {
  if (_y_x10047 === null) {
    ...
    return $std_core_types.Just(_y_x10047.value);
  }
}
...
export function range_fs__lift_for_while_1257(action_0, end_0, i_0) /* forall<a,e> (action : (int) -> e maybe<a>, end : int, i : int) -> e maybe<a> */  { tailcall: while(1)
{
  if ($std_core_types._int_le(i_0,end_0)) {
    ...
    var x_0_10096 = action_0(i_0);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10047_0 /* maybe<961> */ ) {
        return range_fs__mlift_lift_for_while_1257_10076(action_0, end_0, i_0, _y_x10047_0);
      });
    }
    else {
      if (x_0_10096 === null) {
        ...
        return $std_core_types.Just(x_0_10096.value);
      }
    }
  }
  else {
