...
export function hilo_fs_int(_pat_x420__19) /* ((int32, int32)) -> int */  {
   
  var x_10002 = $std_core_types._int_mul(($std_core_types._int_from_int32((_pat_x420__19.fst))),4294967296);
   
  var y_10003 = uint(_pat_x420__19.snd);
...
export function hilo_fs_uint(_pat_x425__20) /* ((int32, int32)) -> int */  {
   
  var x_10004 = $std_core_types._int_mul((uint(_pat_x425__20.fst)),4294967296);
   
  var y_10005 = uint(_pat_x425__20.snd);
...
export function range_fs_fold_int32(start_0, end_0, init, f_0) /* forall<a,e> (start : int32, end : int32, init : a, f : (int32, a) -> e a) -> e a */  { tailcall: while(1)
{
  if ((start_0 > end_0)) {
    ...
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(x_1 /* 1938 */ ) {
...
export function range_fs_fold_while_int32(start_0, end_0, init_0, f_0) /* forall<a,e> (start : int32, end : int32, init : a, f : (int32, a) -> e maybe<a>) -> e a */  { tailcall: while(1)
{
  if ((start_0 > end_0)) {
    ...
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10044_0 /* maybe<2035> */ ) {
...
// monadic lift
export function range_fs__mlift_lift_for32_2291_10073(action, end, i, wild__) /* forall<e> (action : (int32) -> e (), end : int32, i : int32, wild_ : ()) -> e () */  {
   
  var i_0_10016 = ((i + 1)|0);
  return range_fs__lift_for32_2291(action, end, i_0_10016);
}
 
 
// lifted local: range/for32, rep
export function range_fs__lift_for32_2291(action_0, end_0, i_0) /* forall<e> (action : (int32) -> e (), end : int32, i : int32) -> e () */  { tailcall: while(1)
{
  if ((i_0 <= end_0)) {
    ...
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
        return range_fs__mlift_lift_for32_2291_10073(action_0, end_0, i_0, wild___0);
      });
    }
    else {
...
export function range_fs_for32(start, end, action) /* forall<e> (start : int32, end : int32, action : (int32) -> e ()) -> e () */  {
  return range_fs__lift_for32_2291(action, end, start);
}
 
export function for32(n, action) /* forall<e> (n : int32, action : (int32) -> e ()) -> e () */  {
   
  var end_10018 = ((n - 1)|0);
  return range_fs__lift_for32_2291(action, end_10018, zero);
}
 
 
// monadic lift
export function range_fs__mlift_lift_for_while32_2292_10074(action, end, i, _y_x10054) /* forall<a,e> (action : (int32) -> e maybe<a>, end : int32, i : int32, maybe<a>) -> e maybe<a> */  {
  if (_y_x10054 === null) {
     
    var i_0_10020 = ((i + 1)|0);
    return range_fs__lift_for_while32_2292(action, end, i_0_10020);
  }
  else {
...
export function range_fs__lift_for_while32_2292(action_0, end_0, i_0) /* forall<a,e> (action : (int32) -> e maybe<a>, end : int32, i : int32) -> e maybe<a> */  { tailcall: while(1)
{
  if ((i_0 <= end_0)) {
     
    var x_0_10084 = action_0(i_0);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10054_0 /* maybe<2173> */ ) {
        return range_fs__mlift_lift_for_while32_2292_10074(action_0, end_0, i_0, _y_x10054_0);
      });
    }
    else {
      if (x_0_10084 === null) {
...
export function range_fs_for_while32(start, end, action) /* forall<a,e> (start : int32, end : int32, action : (int32) -> e maybe<a>) -> e maybe<a> */  {
  return range_fs__lift_for_while32_2292(action, end, start);
}
 
export function for_while32(n, action) /* forall<a,e> (n : int32, action : (int32) -> e maybe<a>) -> e maybe<a> */  {
   
  var end_10022 = ((n - 1)|0);
  return range_fs__lift_for_while32_2292(action, end_10022, zero);
}
