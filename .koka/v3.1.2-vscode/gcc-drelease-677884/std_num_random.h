...
static inline kk_integer_t kk_std_num_random_random_fs__cfc(kk_std_num_random__random random, kk_context_t* _ctx) { /* forall<e,a> (random : random<e,a>) -> int */ 
  {
    struct kk_std_num_random__Hnd_random* _con_x160 = kk_std_num_random__as_Hnd_random(random, _ctx);
    kk_integer_t _x = _con_x160->_cfc;
...
static inline kk_std_core_hnd__clause0 kk_std_num_random_random_fs__fun_random_int32(kk_std_num_random__random random, kk_context_t* _ctx) { /* forall<e,a> (random : random<e,a>) -> hnd/clause0<int32,random,e,a> */ 
  {
    struct kk_std_num_random__Hnd_random* _con_x161 = kk_std_num_random__as_Hnd_random(random, _ctx);
    kk_std_core_hnd__clause0 _x = _con_x161->_fun_random_int32;
...
static inline kk_std_core_hnd__clause0 kk_std_num_random__select_random_int32(kk_std_num_random__random hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : random<e,a>) -> hnd/clause0<int32,random,e,a> */ 
  {
    struct kk_std_num_random__Hnd_random* _con_x171 = kk_std_num_random__as_Hnd_random(hnd, _ctx);
    kk_std_core_hnd__clause0 _fun_random_int32 = _con_x171->_fun_random_int32;
...
static inline int32_t kk_std_num_random_random_int32(kk_context_t* _ctx) { /* () -> random int32 */ 
  kk_std_core_hnd__ev ev_10198 = kk_evv_at(((KK_IZ(0))),kk_context()); /*hnd/ev<std/num/random/random>*/;
  kk_box_t _x_x172;
  {
    struct kk_std_core_hnd_Ev* _con_x173 = kk_std_core_hnd__as_Ev(ev_10198, _ctx);
    kk_box_t _box_x14 = _con_x173->hnd;
    int32_t m = _con_x173->marker;
    kk_std_num_random__random h = kk_std_num_random__random_unbox(_box_x14, KK_BORROWED, _ctx);
    kk_std_num_random__random_dup(h, _ctx);
    {
      struct kk_std_num_random__Hnd_random* _con_x174 = kk_std_num_random__as_Hnd_random(h, _ctx);
      kk_integer_t _pat_0_0 = _con_x174->_cfc;
      kk_std_core_hnd__clause0 _fun_random_int32 = _con_x174->_fun_random_int32;
      ...
      }
      {
        ...
        _x_x172 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x17, (_fun_unbox_x17, m, ev_10198, _ctx), _ctx); /*35*/
      }
    }
  }
  return kk_int32_unbox(_x_x172, KK_OWNED, _ctx);
}
...
struct kk_std_num_random_strong_random_fun175__t {
  struct kk_function_s _base;
};
extern int32_t kk_std_num_random_strong_random_fun175(kk_function_t _fself, kk_context_t* _ctx);
static inline kk_function_t kk_std_num_random_new_strong_random_fun175(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_num_random_strong_random_fun175, _ctx)
...
// lift anonymous function
struct kk_std_num_random_strong_random_fun178__t {
  struct kk_function_s _base;
  kk_function_t _b_x20_21;
};
extern kk_box_t kk_std_num_random_strong_random_fun178(kk_function_t _fself, kk_context_t* _ctx);
static inline kk_function_t kk_std_num_random_new_strong_random_fun178(kk_function_t _b_x20_21, kk_context_t* _ctx) {
  struct kk_std_num_random_strong_random_fun178__t* _self = kk_function_alloc_as(struct kk_std_num_random_strong_random_fun178__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_num_random_strong_random_fun178, kk_context());
...
// lift anonymous function
struct kk_std_num_random_strong_random_fun180__t {
  struct kk_function_s _base;
};
extern kk_box_t kk_std_num_random_strong_random_fun180(kk_function_t _fself, kk_box_t _x, kk_context_t* _ctx);
static inline kk_function_t kk_std_num_random_new_strong_random_fun180(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_num_random_strong_random_fun180, _ctx)
  return kk_function_dup(_fself,kk_context());
}
...
static inline kk_box_t kk_std_num_random_strong_random(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> <random,ndet|e> a) -> <ndet|e> a */ 
  kk_function_t _b_x20_21 = kk_std_num_random_new_strong_random_fun175(_ctx); /*() -> ndet int32*/;
  kk_std_num_random__random _x_x176;
  kk_std_core_hnd__clause0 _x_x177 = kk_std_core_hnd_clause_tail0(kk_std_num_random_new_strong_random_fun178(_b_x20_21, _ctx), _ctx); /*hnd/clause0<6234,6233,6231,6232>*/
  _x_x176 = kk_std_num_random__new_Hnd_random(kk_reuse_null, 0, kk_integer_from_small(1), _x_x177, _ctx); /*std/num/random/random<5,6>*/
  return kk_std_num_random__handle_random(_x_x176, kk_std_num_random_new_strong_random_fun180(_ctx), action, _ctx);
}


// lift anonymous function
struct kk_std_num_random__default_random_fun181__t {
  struct kk_function_s _base;
};
extern int32_t kk_std_num_random__default_random_fun181(kk_function_t _fself, kk_context_t* _ctx);
static inline kk_function_t kk_std_num_random__new_default_random_fun181(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_num_random__default_random_fun181, _ctx)
  return kk_function_dup(_fself,kk_context());
}
...
// lift anonymous function
struct kk_std_num_random__default_random_fun184__t {
  struct kk_function_s _base;
  kk_function_t _b_x22_23;
};
extern kk_box_t kk_std_num_random__default_random_fun184(kk_function_t _fself, kk_context_t* _ctx);
static inline kk_function_t kk_std_num_random__new_default_random_fun184(kk_function_t _b_x22_23, kk_context_t* _ctx) {
  struct kk_std_num_random__default_random_fun184__t* _self = kk_function_alloc_as(struct kk_std_num_random__default_random_fun184__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_num_random__default_random_fun184, kk_context());
...
// lift anonymous function
struct kk_std_num_random__default_random_fun186__t {
  struct kk_function_s _base;
};
extern kk_box_t kk_std_num_random__default_random_fun186(kk_function_t _fself, kk_box_t _x, kk_context_t* _ctx);
static inline kk_function_t kk_std_num_random__new_default_random_fun186(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_num_random__default_random_fun186, _ctx)
  return kk_function_dup(_fself,kk_context());
}
...
static inline kk_box_t kk_std_num_random__default_random(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> <random,ndet|e> a) -> <ndet|e> a */ 
  kk_function_t _b_x22_23 = kk_std_num_random__new_default_random_fun181(_ctx); /*() -> ndet int32*/;
  kk_std_num_random__random _x_x182;
  kk_std_core_hnd__clause0 _x_x183 = kk_std_core_hnd_clause_tail0(kk_std_num_random__new_default_random_fun184(_b_x22_23, _ctx), _ctx); /*hnd/clause0<6234,6233,6231,6232>*/
  _x_x182 = kk_std_num_random__new_Hnd_random(kk_reuse_null, 0, kk_integer_from_small(1), _x_x183, _ctx); /*std/num/random/random<5,6>*/
  return kk_std_num_random__handle_random(_x_x182, kk_std_num_random__new_default_random_fun186(_ctx), action, _ctx);
}
...
static inline kk_std_num_random__sfc kk_std_num_random_sfc_init32(int32_t seed1, int32_t seed2, kk_context_t* _ctx) { /* (seed1 : int32, seed2 : int32) -> sfc */ 
  kk_std_num_random__sfc sfc0 = kk_std_num_random__new_Sfc((KK_I32(0)), seed1, seed2, (KK_I32(1)), _ctx); /*std/num/random/sfc*/;
  int32_t _own_x147 = (KK_I32(12)); /*int32*/;
  return kk_std_num_random__lift_sfc_init32_10159(_own_x147, sfc0, _ctx);
}
...
static inline int32_t kk_std_num_random__mlift_pseudo_random_10189(kk_std_num_random__sfc_result sfc_0, kk_unit_t wild__, kk_context_t* _ctx) { /* forall<h,e> (sfc@0 : sfc-result, wild_ : ()) -> <local<h>|e> int32 */ 
  {
    kk_std_num_random__sfc _pat_0_1 = sfc_0.rstate;
...
static inline bool kk_std_num_random__mlift_random_bool_10191(int32_t _y_x10173, kk_context_t* _ctx) { /* (int32) -> random bool */ 
  return (_y_x10173 >= ((KK_I32(0))));
}
...
static inline kk_integer_t kk_std_num_random__mlift_random_int_10192(int32_t _y_x10174, kk_context_t* _ctx) { /* (int32) -> random int */ 
  return kk_integer_from_int(_y_x10174,kk_context());
}
...
static inline int64_t kk_std_num_random__mlift_random_int64_10193(int32_t _y_x10175, int32_t _y_x10176, kk_context_t* _ctx) { /* (int32, int32) -> random int64 */ 
  return kk_int64_hi_lo(_y_x10175,_y_x10176);
}
...
static inline bool kk_std_num_random_srandom_bool(kk_context_t* _ctx) { /* () -> ndet bool */ 
  int32_t _x_x288 = kk_std_num_random_srandom_int32(_ctx); /*int32*/
  return (_x_x288 >= ((KK_I32(0))));
}
...
static inline kk_integer_t kk_std_num_random_srandom_int(kk_context_t* _ctx) { /* () -> ndet int */ 
  int32_t _x_x290 = kk_std_num_random_srandom_int32(_ctx); /*int32*/
  return kk_integer_from_int(_x_x290,kk_context());
}
