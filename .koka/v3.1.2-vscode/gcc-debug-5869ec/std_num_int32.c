...
kk_string_t kk_std_num_int32_show_hex(int32_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int32, width : ? int, use-capitals : ? bool, pre : ? string) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(width, _ctx)) {
    ...
    _x_x174 = _uniq_width_448; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(width, _ctx);
    _x_x174 = kk_integer_from_small(1); /*int*/
  }
  _x_x173 = kk_integer_box(_x_x174, _ctx); /*1003*/
  _x_x172 = kk_std_core_types__new_Optional(_x_x173, _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(use_capitals, _ctx)) {
    ...
    _x_x177 = _uniq_use_capitals_452; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(use_capitals, _ctx);
    _x_x177 = true; /*bool*/
  }
  _x_x176 = kk_bool_box(_x_x177); /*1003*/
  _x_x175 = kk_std_core_types__new_Optional(_x_x176, _ctx); /*? 1003*/
  ...
  _x_x179 = kk_string_box(_x_x180); /*1003*/
  _x_x178 = kk_std_core_types__new_Optional(_x_x179, _ctx); /*? 1003*/
...
kk_string_t kk_std_num_int32_show_hex32(int32_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int32, width : ? int, use-capitals : ? bool, pre : ? string) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(width, _ctx)) {
    ...
    kk_std_core_types__optional_drop(width, _ctx);
    _x_x186 = _uniq_width_539; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(width, _ctx);
    _x_x186 = kk_integer_from_small(8); /*int*/
  }
  _x_x185 = kk_integer_box(_x_x186, _ctx); /*1003*/
  _x_x184 = kk_std_core_types__new_Optional(_x_x185, _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(use_capitals, _ctx)) {
    ...
    kk_std_core_types__optional_drop(use_capitals, _ctx);
    _x_x189 = _uniq_use_capitals_543; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(use_capitals, _ctx);
    _x_x189 = true; /*bool*/
  }
  _x_x188 = kk_bool_box(_x_x189); /*1003*/
  _x_x187 = kk_std_core_types__new_Optional(_x_x188, _ctx); /*? 1003*/
  ...
  _x_x191 = kk_string_box(_x_x192); /*1003*/
  _x_x190 = kk_std_core_types__new_Optional(_x_x191, _ctx); /*? 1003*/
...
int32_t kk_std_num_int32_abs(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> exn int32 */ 
  ...
  bool _match_x156;
  kk_box_t _x_x196 = kk_std_core_hnd__open_none1(kk_std_num_int32_new_abs_fun197(_ctx), kk_bool_box(_x_x1_10070), _ctx); /*1001*/
...
kk_box_t kk_std_num_int32_range_fs__mlift_fold_int32_10071(int32_t end, kk_function_t f, int32_t start, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e> (end : int32, f : (int32, a) -> e a, start : int32, x : a) -> e a */ 
  ...
  kk_box_t _brw_x127 = kk_std_num_int32_range_fs_fold_int32(_own_x126, end, x, f, _ctx); /*116*/;
...
kk_box_t kk_std_num_int32_range_fs_fold_int32(int32_t start_0, int32_t end_0, kk_box_t init, kk_function_t f_0, kk_context_t* _ctx) { /* forall<a,e> (start : int32, end : int32, init : a, f : (int32, a) -> e a) -> e a */ 
  ...
  {
    kk_box_t x_0_10075;
    kk_function_t _x_x214 = kk_function_dup(f_0, _ctx); /*(int32, 1938) -> 1939 1938*/
    x_0_10075 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_box_t, kk_context_t*), _x_x214, (_x_x214, start_0, init, _ctx), _ctx); /*1938*/
    if (kk_yielding(kk_context())) {
      kk_box_drop(x_0_10075, _ctx);
      kk_function_t _x_x215;
      kk_function_dup(f_0, _ctx);
      _x_x215 = kk_std_num_int32_range_fs_new_fold_int32_fun216(f_0, end_0, start_0, _ctx); /*(x@1 : 1938) -> 1939 1938*/
...
static kk_box_t kk_std_num_int32_range_fs_fold_while_int32_fun220(kk_function_t _fself, kk_box_t _b_x81, kk_context_t* _ctx) {
  ...
  kk_std_core_types__maybe _x_x221 = kk_std_core_types__maybe_unbox(_b_x81, KK_OWNED, _ctx); /*maybe<2035>*/
...
kk_box_t kk_std_num_int32_range_fs_fold_while_int32(int32_t start_0, int32_t end_0, kk_box_t init_0, kk_function_t f_0, kk_context_t* _ctx) { /* forall<a,e> (start : int32, end : int32, init : a, f : (int32, a) -> e maybe<a>) -> e a */ 
  ...
  }
  {
    ...
    kk_function_t _x_x219 = kk_function_dup(f_0, _ctx); /*(int32, 2035) -> 2036 maybe<2035>*/
    kk_box_t _x_x218 = kk_box_dup(init_0, _ctx); /*2035*/
    x_0_10078 = kk_function_call(kk_std_core_types__maybe, (kk_function_t, int32_t, kk_box_t, kk_context_t*), _x_x219, (_x_x219, start_0, _x_x218, _ctx), _ctx); /*maybe<2035>*/
    if (kk_yielding(kk_context())) {
...
kk_unit_t kk_std_num_int32_range_fs__mlift_lift_for32_2291_10073(kk_function_t action, int32_t end, int32_t i, kk_unit_t wild__, kk_context_t* _ctx) { /* forall<e> (action : (int32) -> e (), end : int32, i : int32, wild_ : ()) -> e () */ 
  int32_t i_0_10016 = (int32_t)((uint32_t)i + (uint32_t)((KK_I32(1)))); /*int32*/;
  kk_std_num_int32_range_fs__lift_for32_2291(action, end, i_0_10016, _ctx); return kk_Unit;
}
...
// lift anonymous function
struct kk_std_num_int32_range_fs__lift_for32_2291_fun226__t {
  struct kk_function_s _base;
  kk_function_t action_0;
  int32_t end_0;
  int32_t i_0;
};
static kk_box_t kk_std_num_int32_range_fs__lift_for32_2291_fun226(kk_function_t _fself, kk_box_t _b_x85, kk_context_t* _ctx);
static kk_function_t kk_std_num_int32_range_fs__new_lift_for32_2291_fun226(kk_function_t action_0, int32_t end_0, int32_t i_0, kk_context_t* _ctx) {
  struct kk_std_num_int32_range_fs__lift_for32_2291_fun226__t* _self = kk_function_alloc_as(struct kk_std_num_int32_range_fs__lift_for32_2291_fun226__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_num_int32_range_fs__lift_for32_2291_fun226, kk_context());
...
static kk_box_t kk_std_num_int32_range_fs__lift_for32_2291_fun226(kk_function_t _fself, kk_box_t _b_x85, kk_context_t* _ctx) {
  struct kk_std_num_int32_range_fs__lift_for32_2291_fun226__t* _self = kk_function_as(struct kk_std_num_int32_range_fs__lift_for32_2291_fun226__t*, _fself, _ctx);
  ...
  kk_std_num_int32_range_fs__mlift_lift_for32_2291_10073(action_0, end_0, i_0, wild___0_87, _ctx);
...
kk_unit_t kk_std_num_int32_range_fs__lift_for32_2291(kk_function_t action_0, int32_t end_0, int32_t i_0, kk_context_t* _ctx) { /* forall<e> (action : (int32) -> e (), end : int32, i : int32) -> e () */ 
  ...
  if (_match_x118) {
    ...
    kk_function_t _x_x224 = kk_function_dup(action_0, _ctx); /*(int32) -> 2092 ()*/
    kk_function_call(kk_unit_t, (kk_function_t, int32_t, kk_context_t*), _x_x224, (_x_x224, i_0, _ctx), _ctx);
    if (kk_yielding(kk_context())) {
      kk_box_t _x_x225 = kk_std_core_hnd_yield_extend(kk_std_num_int32_range_fs__new_lift_for32_2291_fun226(action_0, end_0, i_0, _ctx), _ctx); /*4093*/
...
kk_std_core_types__maybe kk_std_num_int32_range_fs__mlift_lift_for_while32_2292_10074(kk_function_t action, int32_t end, int32_t i, kk_std_core_types__maybe _y_x10054, kk_context_t* _ctx) { /* forall<a,e> (action : (int32) -> e maybe<a>, end : int32, i : int32, maybe<a>) -> e maybe<a> */ 
  if (kk_std_core_types__is_Nothing(_y_x10054, _ctx)) {
    int32_t i_0_10020 = (int32_t)((uint32_t)i + (uint32_t)((KK_I32(1)))); /*int32*/;
    return kk_std_num_int32_range_fs__lift_for_while32_2292(action, end, i_0_10020, _ctx);
  }
  {
...
// lift anonymous function
struct kk_std_num_int32_range_fs__lift_for_while32_2292_fun230__t {
  struct kk_function_s _base;
  kk_function_t action_0;
  int32_t end_0;
  int32_t i_0;
};
static kk_box_t kk_std_num_int32_range_fs__lift_for_while32_2292_fun230(kk_function_t _fself, kk_box_t _b_x89, kk_context_t* _ctx);
static kk_function_t kk_std_num_int32_range_fs__new_lift_for_while32_2292_fun230(kk_function_t action_0, int32_t end_0, int32_t i_0, kk_context_t* _ctx) {
  struct kk_std_num_int32_range_fs__lift_for_while32_2292_fun230__t* _self = kk_function_alloc_as(struct kk_std_num_int32_range_fs__lift_for_while32_2292_fun230__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_num_int32_range_fs__lift_for_while32_2292_fun230, kk_context());
  _self->action_0 = action_0;
  _self->end_0 = end_0;
  _self->i_0 = i_0;
  return kk_datatype_from_base(&_self->_base, kk_context());
...
static kk_box_t kk_std_num_int32_range_fs__lift_for_while32_2292_fun230(kk_function_t _fself, kk_box_t _b_x89, kk_context_t* _ctx) {
  struct kk_std_num_int32_range_fs__lift_for_while32_2292_fun230__t* _self = kk_function_as(struct kk_std_num_int32_range_fs__lift_for_while32_2292_fun230__t*, _fself, _ctx);
  kk_function_t action_0 = _self->action_0; /* (int32) -> 2174 maybe<2173> */
  int32_t end_0 = _self->end_0; /* int32 */
  int32_t i_0 = _self->i_0; /* int32 */
  kk_drop_match(_self, {kk_function_dup(action_0, _ctx);kk_skip_dup(end_0, _ctx);kk_skip_dup(i_0, _ctx);}, {}, _ctx)
  kk_std_core_types__maybe _y_x10054_0_91 = kk_std_core_types__maybe_unbox(_b_x89, KK_OWNED, _ctx); /*maybe<2173>*/;
  kk_std_core_types__maybe _x_x231 = kk_std_num_int32_range_fs__mlift_lift_for_while32_2292_10074(action_0, end_0, i_0, _y_x10054_0_91, _ctx); /*maybe<2173>*/
...
kk_std_core_types__maybe kk_std_num_int32_range_fs__lift_for_while32_2292(kk_function_t action_0, int32_t end_0, int32_t i_0, kk_context_t* _ctx) { /* forall<a,e> (action : (int32) -> e maybe<a>, end : int32, i : int32) -> e maybe<a> */ 
  ...
  if (_match_x116) {
    ...
    kk_function_t _x_x228 = kk_function_dup(action_0, _ctx); /*(int32) -> 2174 maybe<2173>*/
    x_0_10084 = kk_function_call(kk_std_core_types__maybe, (kk_function_t, int32_t, kk_context_t*), _x_x228, (_x_x228, i_0, _ctx), _ctx); /*maybe<2173>*/
    if (kk_yielding(kk_context())) {
      kk_std_core_types__maybe_drop(x_0_10084, _ctx);
      kk_box_t _x_x229 = kk_std_core_hnd_yield_extend(kk_std_num_int32_range_fs__new_lift_for_while32_2292_fun230(action_0, end_0, i_0, _ctx), _ctx); /*4175*/
