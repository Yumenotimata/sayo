...
static inline kk_integer_t kk_std_num_random_random_fs__cfc(kk_std_num_random__random random, kk_context_t* _ctx) { /* forall<e,a> (random : random<e,a>) -> int */ 
  {
    struct kk_std_num_random__Hnd_random* _con_x175 = kk_std_num_random__as_Hnd_random(random, _ctx);
    kk_integer_t _x = _con_x175->_cfc;
...
static inline kk_std_core_hnd__clause0 kk_std_num_random_random_fs__fun_random_int32(kk_std_num_random__random random, kk_context_t* _ctx) { /* forall<e,a> (random : random<e,a>) -> hnd/clause0<int32,random,e,a> */ 
  {
    struct kk_std_num_random__Hnd_random* _con_x176 = kk_std_num_random__as_Hnd_random(random, _ctx);
    kk_std_core_hnd__clause0 _x = _con_x176->_fun_random_int32;
...
static inline kk_std_core_hnd__clause0 kk_std_num_random__select_random_int32(kk_std_num_random__random hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : random<e,a>) -> hnd/clause0<int32,random,e,a> */ 
  {
    struct kk_std_num_random__Hnd_random* _con_x186 = kk_std_num_random__as_Hnd_random(hnd, _ctx);
    kk_std_core_hnd__clause0 _fun_random_int32 = _con_x186->_fun_random_int32;
...
static inline int32_t kk_std_num_random_random_int32(kk_context_t* _ctx) { /* () -> random int32 */ 
  ...
  kk_box_t _x_x187;
  {
    struct kk_std_core_hnd_Ev* _con_x188 = kk_std_core_hnd__as_Ev(ev_10051, _ctx);
    kk_box_t _box_x14 = _con_x188->hnd;
    int32_t m = _con_x188->marker;
    ...
    {
      struct kk_std_num_random__Hnd_random* _con_x189 = kk_std_num_random__as_Hnd_random(h, _ctx);
      kk_integer_t _pat_0_0 = _con_x189->_cfc;
      kk_std_core_hnd__clause0 _fun_random_int32 = _con_x189->_fun_random_int32;
  ...
  return kk_int32_unbox(_x_x187, KK_OWNED, _ctx);
}
...
struct kk_std_num_random_strong_random_fun190__t {
  struct kk_function_s _base;
};
extern int32_t kk_std_num_random_strong_random_fun190(kk_function_t _fself, kk_context_t* _ctx);
static inline kk_function_t kk_std_num_random_new_strong_random_fun190(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_num_random_strong_random_fun190, _ctx)
...
// lift anonymous function
struct kk_std_num_random_strong_random_fun193__t {
  struct kk_function_s _base;
  kk_function_t _b_x20_21;
};
extern kk_box_t kk_std_num_random_strong_random_fun193(kk_function_t _fself, kk_context_t* _ctx);
static inline kk_function_t kk_std_num_random_new_strong_random_fun193(kk_function_t _b_x20_21, kk_context_t* _ctx) {
  struct kk_std_num_random_strong_random_fun193__t* _self = kk_function_alloc_as(struct kk_std_num_random_strong_random_fun193__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_num_random_strong_random_fun193, kk_context());
...
static inline kk_function_t kk_std_num_random_new_strong_random_fun195(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_num_random_strong_random_fun195, _ctx)
  return kk_function_dup(_fself,kk_context());
}
...
// lift anonymous function
struct kk_std_num_random__default_random_fun196__t {
  struct kk_function_s _base;
};
extern int32_t kk_std_num_random__default_random_fun196(kk_function_t _fself, kk_context_t* _ctx);
static inline kk_function_t kk_std_num_random__new_default_random_fun196(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_num_random__default_random_fun196, _ctx)
  return kk_function_dup(_fself,kk_context());
}
...
// lift anonymous function
struct kk_std_num_random__default_random_fun199__t {
  struct kk_function_s _base;
  kk_function_t _b_x22_23;
};
extern kk_box_t kk_std_num_random__default_random_fun199(kk_function_t _fself, kk_context_t* _ctx);
static inline kk_function_t kk_std_num_random__new_default_random_fun199(kk_function_t _b_x22_23, kk_context_t* _ctx) {
  struct kk_std_num_random__default_random_fun199__t* _self = kk_function_alloc_as(struct kk_std_num_random__default_random_fun199__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_num_random__default_random_fun199, kk_context());
...
static inline kk_function_t kk_std_num_random__new_default_random_fun201(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_num_random__default_random_fun201, _ctx)
  return kk_function_dup(_fself,kk_context());
}
...
static inline bool kk_std_num_random_srandom_bool(kk_context_t* _ctx) { /* () -> ndet bool */ 
  int32_t _x_x306 = kk_std_num_random_srandom_int32(_ctx); /*int32*/
  return (_x_x306 >= ((KK_I32(0))));
}
...
static inline kk_integer_t kk_std_num_random_srandom_int(kk_context_t* _ctx) { /* () -> ndet int */ 
  ...
  return kk_integer_from_int(_x_x308,kk_context());
}
