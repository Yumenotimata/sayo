...
kk_string_t kk_std_num_int64_show_hex(int64_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int64, width : ? int, use-capitals : ? bool, pre : ? string) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(width, _ctx)) {
    ...
    _x_x288 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(width, _ctx);
    _x_x288 = kk_integer_from_small(1); /*int*/
  }
  _x_x287 = kk_integer_box(_x_x288, _ctx); /*1003*/
  _x_x286 = kk_std_core_types__new_Optional(_x_x287, _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(use_capitals, _ctx)) {
    ...
    _x_x291 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(use_capitals, _ctx);
    _x_x291 = true; /*bool*/
  }
  _x_x290 = kk_bool_box(_x_x291); /*1003*/
  _x_x289 = kk_std_core_types__new_Optional(_x_x290, _ctx); /*? 1003*/
  ...
  _x_x293 = kk_string_box(_x_x294); /*1003*/
  _x_x292 = kk_std_core_types__new_Optional(_x_x293, _ctx); /*? 1003*/
...
kk_string_t kk_std_num_int64_show_hex64(int64_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int64, width : ? int, use-capitals : ? bool, pre : ? string) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(width, _ctx)) {
    ...
    kk_std_core_types__optional_drop(width, _ctx);
    _x_x299 = _uniq_width_574; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(width, _ctx);
    _x_x299 = kk_integer_from_small(16); /*int*/
  }
  _x_x298 = kk_integer_box(_x_x299, _ctx); /*1003*/
  _x_x297 = kk_std_core_types__new_Optional(_x_x298, _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(use_capitals, _ctx)) {
    ...
    kk_std_core_types__optional_drop(use_capitals, _ctx);
    _x_x302 = _uniq_use_capitals_578; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(use_capitals, _ctx);
    _x_x302 = true; /*bool*/
  }
  _x_x301 = kk_bool_box(_x_x302); /*1003*/
  _x_x300 = kk_std_core_types__new_Optional(_x_x301, _ctx); /*? 1003*/
  ...
  _x_x304 = kk_string_box(_x_x305); /*1003*/
  _x_x303 = kk_std_core_types__new_Optional(_x_x304, _ctx); /*? 1003*/
...
int64_t kk_std_num_int64_abs(int64_t i, kk_context_t* _ctx) { /* (i : int64) -> exn int64 */ 
  ...
  bool _match_x264;
  kk_box_t _x_x312 = kk_std_core_hnd__open_none1(kk_std_num_int64_new_abs_fun313(_ctx), kk_bool_box(_x_x1_10096), _ctx); /*1001*/
  ...
  }
  {
    ...
    if (_match_x265) {
      _x_x315 = kk_std_core_hnd__open_none1(kk_std_num_int64_new_abs_fun316(_ctx), kk_int64_box(i, _ctx), _ctx); /*1001*/
    }
    else {
      kk_string_t _x_x319;
      ...
      _x_x315 = kk_std_core_exn_throw(_x_x319, kk_std_core_types__new_None(_ctx), _ctx); /*1001*/
    }
...
int64_t kk_std_num_int64_cdiv(int64_t i, int64_t j, kk_context_t* _ctx) { /* (i : int64, j : int64) -> exn int64 */ 
  ...
  }
  {
    ...
    bool _match_x259;
    int64_t _x_x333;
    kk_box_t _x_x334 = kk_std_core_hnd__open_none1(kk_std_num_int64_new_cdiv_fun335(_b_x40_47, _ctx), kk_integer_box(_b_x41_48, _ctx), _ctx); /*1001*/
...
int64_t kk_std_num_int64_cmod(int64_t i, int64_t j, kk_context_t* _ctx) { /* (i : int64, j : int64) -> exn int64 */ 
  ...
  }
  {
    ...
    bool _match_x256;
    int64_t _x_x346;
    kk_box_t _x_x347 = kk_std_core_hnd__open_none1(kk_std_num_int64_new_cmod_fun348(_b_x53_60, _ctx), kk_integer_box(_b_x54_61, _ctx), _ctx); /*1001*/
...
kk_box_t kk_std_num_int64_range_fs_fold_int64(int64_t start_0, int64_t end_0, kk_box_t init, kk_function_t f_0, kk_context_t* _ctx) { /* forall<a,e> (start : int64, end : int64, init : a, f : (int64, a) -> e a) -> e a */ 
  ...
  {
    kk_box_t x_0_10102;
    kk_function_t _x_x382 = kk_function_dup(f_0, _ctx); /*(int64, 2000) -> 2001 2000*/
    x_0_10102 = kk_function_call(kk_box_t, (kk_function_t, int64_t, kk_box_t, kk_context_t*), _x_x382, (_x_x382, start_0, init, _ctx), _ctx); /*2000*/
...
kk_std_core_types__maybe kk_std_num_int64_range_fs__mlift_lift_for_while64_2551_10101(kk_function_t action, int64_t end, int64_t i, kk_std_core_types__maybe _y_x10082, kk_context_t* _ctx) { /* forall<a,e> (action : (int64) -> e maybe<a>, end : int64, i : int64, maybe<a>) -> e maybe<a> */ 
  if (kk_std_core_types__is_Nothing(_y_x10082, _ctx)) {
    ...
    return kk_std_num_int64_range_fs__lift_for_while64_2551(action, end, i_0_10018, _ctx);
  }
  {
...
// lift anonymous function
struct kk_std_num_int64_range_fs__lift_for_while64_2551_fun391__t {
  struct kk_function_s _base;
  kk_function_t action_0;
  int64_t end_0;
  int64_t i_0;
};
static kk_box_t kk_std_num_int64_range_fs__lift_for_while64_2551_fun391(kk_function_t _fself, kk_box_t _b_x97, kk_context_t* _ctx);
static kk_function_t kk_std_num_int64_range_fs__new_lift_for_while64_2551_fun391(kk_function_t action_0, int64_t end_0, int64_t i_0, kk_context_t* _ctx) {
  struct kk_std_num_int64_range_fs__lift_for_while64_2551_fun391__t* _self = kk_function_alloc_as(struct kk_std_num_int64_range_fs__lift_for_while64_2551_fun391__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_num_int64_range_fs__lift_for_while64_2551_fun391, kk_context());
...
static kk_box_t kk_std_num_int64_range_fs__lift_for_while64_2551_fun391(kk_function_t _fself, kk_box_t _b_x97, kk_context_t* _ctx) {
  struct kk_std_num_int64_range_fs__lift_for_while64_2551_fun391__t* _self = kk_function_as(struct kk_std_num_int64_range_fs__lift_for_while64_2551_fun391__t*, _fself, _ctx);
  ...
  kk_std_core_types__maybe _y_x10082_0_99 = kk_std_core_types__maybe_unbox(_b_x97, KK_OWNED, _ctx); /*maybe<2075>*/;
  kk_std_core_types__maybe _x_x392 = kk_std_num_int64_range_fs__mlift_lift_for_while64_2551_10101(action_0, end_0, i_0, _y_x10082_0_99, _ctx); /*maybe<2075>*/
...
kk_std_core_types__maybe kk_std_num_int64_range_fs__lift_for_while64_2551(kk_function_t action_0, int64_t end_0, int64_t i_0, kk_context_t* _ctx) { /* forall<a,e> (action : (int64) -> e maybe<a>, end : int64, i : int64) -> e maybe<a> */ 
  ...
  if (_match_x230) {
    ...
    kk_function_t _x_x389 = kk_function_dup(action_0, _ctx); /*(int64) -> 2076 maybe<2075>*/
    x_0_10105 = kk_function_call(kk_std_core_types__maybe, (kk_function_t, int64_t, kk_context_t*), _x_x389, (_x_x389, i_0, _ctx), _ctx); /*maybe<2075>*/
    if (kk_yielding(kk_context())) {
      kk_std_core_types__maybe_drop(x_0_10105, _ctx);
      kk_box_t _x_x390 = kk_std_core_hnd_yield_extend(kk_std_num_int64_range_fs__new_lift_for_while64_2551_fun391(action_0, end_0, i_0, _ctx), _ctx); /*4077*/
...
kk_string_t kk_std_num_int64_test_prefix_sum(kk_context_t* _ctx) { /* () -> string */ 
  ...
  if (kk_std_core_types__is_Optional(_match_x228, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x121, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x228, _ctx);
    _x_x409 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x228, _ctx);
    _x_x409 = kk_integer_from_small(1); /*int*/
  }
  _x_x408 = kk_integer_box(_x_x409, _ctx); /*1003*/
  _x_x407 = kk_std_core_types__new_Optional(_x_x408, _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(_match_x227, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x123);
    kk_std_core_types__optional_drop(_match_x227, _ctx);
    _x_x412 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x227, _ctx);
    _x_x412 = true; /*bool*/
  }
  _x_x411 = kk_bool_box(_x_x412); /*1003*/
  _x_x410 = kk_std_core_types__new_Optional(_x_x411, _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(_match_x226, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x125);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x226, _ctx);
    _x_x415 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x226, _ctx);
  ...
  _x_x414 = kk_string_box(_x_x415); /*1003*/
  _x_x413 = kk_std_core_types__new_Optional(_x_x414, _ctx); /*? 1003*/
...
kk_string_t kk_std_num_int64_test_bit_spread1(kk_context_t* _ctx) { /* () -> string */ 
  ...
  if (kk_std_core_types__is_Optional(_match_x225, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x130, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x225, _ctx);
    _x_x420 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x225, _ctx);
    _x_x420 = kk_integer_from_small(1); /*int*/
  }
  _x_x419 = kk_integer_box(_x_x420, _ctx); /*1003*/
  _x_x418 = kk_std_core_types__new_Optional(_x_x419, _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(_match_x224, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x132);
    kk_std_core_types__optional_drop(_match_x224, _ctx);
    _x_x423 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x224, _ctx);
    _x_x423 = true; /*bool*/
  }
  _x_x422 = kk_bool_box(_x_x423); /*1003*/
  _x_x421 = kk_std_core_types__new_Optional(_x_x422, _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(_match_x223, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x134);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x223, _ctx);
    _x_x426 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x223, _ctx);
  ...
  _x_x425 = kk_string_box(_x_x426); /*1003*/
  _x_x424 = kk_std_core_types__new_Optional(_x_x425, _ctx); /*? 1003*/
...
kk_string_t kk_std_num_int64_test_bit_spread2(kk_context_t* _ctx) { /* () -> string */ 
  ...
  if (kk_std_core_types__is_Optional(_match_x222, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x139, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x222, _ctx);
    _x_x431 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x222, _ctx);
    _x_x431 = kk_integer_from_small(1); /*int*/
  }
  _x_x430 = kk_integer_box(_x_x431, _ctx); /*1003*/
  _x_x429 = kk_std_core_types__new_Optional(_x_x430, _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(_match_x221, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x141);
    kk_std_core_types__optional_drop(_match_x221, _ctx);
    _x_x434 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x221, _ctx);
    _x_x434 = true; /*bool*/
  }
  _x_x433 = kk_bool_box(_x_x434); /*1003*/
  _x_x432 = kk_std_core_types__new_Optional(_x_x433, _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(_match_x220, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x143);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x220, _ctx);
    _x_x437 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x220, _ctx);
  ...
  _x_x436 = kk_string_box(_x_x437); /*1003*/
  _x_x435 = kk_std_core_types__new_Optional(_x_x436, _ctx); /*? 1003*/
...
kk_string_t kk_std_num_int64_test_clmulr1(kk_context_t* _ctx) { /* () -> string */ 
  ...
  if (kk_std_core_types__is_Optional(_match_x219, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x148, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x219, _ctx);
    _b_x149_160 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x219, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x218, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x150);
    kk_std_core_types__optional_drop(_match_x218, _ctx);
    _b_x151_161 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x218, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x217, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x152);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x217, _ctx);
    _b_x153_162 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x217, _ctx);
  ...
  kk_std_core_types__optional _x_x446 = kk_std_core_types__new_Optional(kk_integer_box(_b_x149_160, _ctx), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x447 = kk_std_core_types__new_Optional(kk_bool_box(_b_x151_161), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x448 = kk_std_core_types__new_Optional(kk_string_box(_b_x153_162), _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(_match_x216, _ctx)) {
    ...
    kk_integer_t _uniq_width_527_0 = kk_integer_unbox(_box_x154, _ctx);
    kk_integer_dup(_uniq_width_527_0, _ctx);
    kk_std_core_types__optional_drop(_match_x216, _ctx);
    _b_x155_163 = _uniq_width_527_0; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x216, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x215, _ctx)) {
    ...
    bool _uniq_use_capitals_531_0 = kk_bool_unbox(_box_x156);
    kk_std_core_types__optional_drop(_match_x215, _ctx);
    _b_x157_164 = _uniq_use_capitals_531_0; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x215, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x214, _ctx)) {
    ...
    kk_string_t _uniq_pre_535_0 = kk_string_unbox(_box_x158);
    kk_string_dup(_uniq_pre_535_0, _ctx);
    kk_std_core_types__optional_drop(_match_x214, _ctx);
    _b_x159_165 = _uniq_pre_535_0; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x214, _ctx);
  ...
  kk_std_core_types__optional _x_x455 = kk_std_core_types__new_Optional(kk_integer_box(_b_x155_163, _ctx), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x456 = kk_std_core_types__new_Optional(kk_bool_box(_b_x157_164), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x457 = kk_std_core_types__new_Optional(kk_string_box(_b_x159_165), _ctx); /*? 1003*/
...
kk_string_t kk_std_num_int64_test_clmulr2(kk_context_t* _ctx) { /* () -> string */ 
  ...
  if (kk_std_core_types__is_Optional(_match_x213, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x166, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x213, _ctx);
    _b_x167_178 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x213, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x212, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x168);
    kk_std_core_types__optional_drop(_match_x212, _ctx);
    _b_x169_179 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x212, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x211, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x170);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x211, _ctx);
    _b_x171_180 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x211, _ctx);
  ...
  kk_std_core_types__optional _x_x463 = kk_std_core_types__new_Optional(kk_integer_box(_b_x167_178, _ctx), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x464 = kk_std_core_types__new_Optional(kk_bool_box(_b_x169_179), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x465 = kk_std_core_types__new_Optional(kk_string_box(_b_x171_180), _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(_match_x210, _ctx)) {
    ...
    kk_integer_t _uniq_width_527_0 = kk_integer_unbox(_box_x172, _ctx);
    kk_integer_dup(_uniq_width_527_0, _ctx);
    kk_std_core_types__optional_drop(_match_x210, _ctx);
    _b_x173_181 = _uniq_width_527_0; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x210, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x209, _ctx)) {
    ...
    bool _uniq_use_capitals_531_0 = kk_bool_unbox(_box_x174);
    kk_std_core_types__optional_drop(_match_x209, _ctx);
    _b_x175_182 = _uniq_use_capitals_531_0; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x209, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x208, _ctx)) {
    ...
    kk_string_t _uniq_pre_535_0 = kk_string_unbox(_box_x176);
    kk_string_dup(_uniq_pre_535_0, _ctx);
    kk_std_core_types__optional_drop(_match_x208, _ctx);
    _b_x177_183 = _uniq_pre_535_0; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x208, _ctx);
  ...
  kk_std_core_types__optional _x_x472 = kk_std_core_types__new_Optional(kk_integer_box(_b_x173_181, _ctx), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x473 = kk_std_core_types__new_Optional(kk_bool_box(_b_x175_182), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x474 = kk_std_core_types__new_Optional(kk_string_box(_b_x177_183), _ctx); /*? 1003*/
...
kk_string_t kk_std_num_int64_test_clmulrev1(kk_context_t* _ctx) { /* () -> string */ 
  ...
  if (kk_std_core_types__is_Optional(_match_x207, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x184, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x207, _ctx);
    _b_x185_196 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x207, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x206, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x186);
    kk_std_core_types__optional_drop(_match_x206, _ctx);
    _b_x187_197 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x206, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x205, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x188);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x205, _ctx);
    _b_x189_198 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x205, _ctx);
  ...
  kk_std_core_types__optional _x_x485 = kk_std_core_types__new_Optional(kk_integer_box(_b_x185_196, _ctx), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x486 = kk_std_core_types__new_Optional(kk_bool_box(_b_x187_197), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x487 = kk_std_core_types__new_Optional(kk_string_box(_b_x189_198), _ctx); /*? 1003*/
  ...
  if (kk_std_core_types__is_Optional(_match_x204, _ctx)) {
    ...
    kk_integer_t _uniq_width_527_0 = kk_integer_unbox(_box_x190, _ctx);
    kk_integer_dup(_uniq_width_527_0, _ctx);
    kk_std_core_types__optional_drop(_match_x204, _ctx);
    _b_x191_199 = _uniq_width_527_0; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x204, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x203, _ctx)) {
    ...
    bool _uniq_use_capitals_531_0 = kk_bool_unbox(_box_x192);
    kk_std_core_types__optional_drop(_match_x203, _ctx);
    _b_x193_200 = _uniq_use_capitals_531_0; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x203, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x202, _ctx)) {
    ...
    kk_string_t _uniq_pre_535_0 = kk_string_unbox(_box_x194);
    kk_string_dup(_uniq_pre_535_0, _ctx);
    kk_std_core_types__optional_drop(_match_x202, _ctx);
    _b_x195_201 = _uniq_pre_535_0; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x202, _ctx);
  ...
  kk_std_core_types__optional _x_x494 = kk_std_core_types__new_Optional(kk_integer_box(_b_x191_199, _ctx), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x495 = kk_std_core_types__new_Optional(kk_bool_box(_b_x193_200), _ctx); /*? 1003*/
  kk_std_core_types__optional _x_x496 = kk_std_core_types__new_Optional(kk_string_box(_b_x195_201), _ctx); /*? 1003*/
