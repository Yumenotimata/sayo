...
// monadic lift
export function _mlift_lift_forz_868_10045(action, i, n, wild__) /* forall<e> (action : (ssize_t) -> e (), i : ssize_t, n : ssize_t, wild_ : ()) -> e () */  {
  ...
  if ((i_0 < n_0)) {
    ...
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
        return _mlift_lift_forz_868_10045(action_0, i_0, n_0, wild___0);
      });
    }
    else {
...
export function vector_init(n, f) /* forall<a,e> (n : int, f : (int) -> e a) -> e vector<a> */  {
  ...
  var x_10054 = _lift_forz_868(function(i_0 /* ssize_t */ ) {
       
      var x_0_10057 = f($std_core_types._int_from_int32(i_0));
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10027 /* 512 */ ) {
          return (v)[i_0] = _y_x10027;
        });
      }
      else {
...
export function foreach_indexedz(v, f) /* forall<a,e> (v : vector<a>, f : (ssize_t, a) -> e ()) -> e () */  {
  ...
  var i = 0;
  return _lift_forz_868(function(i_0 /* ssize_t */ ) {
      return f(i_0, (v)[i_0]);
    }, n_10003, i);
}
...
// monadic lift
export function _mlift_lift_for_whilez_869_10048(action, i, n, _y_x10035) /* forall<a,e> (action : (ssize_t) -> e maybe<a>, i : ssize_t, n : ssize_t, maybe<a>) -> e maybe<a> */  {
  if (_y_x10035 === null) {
...
export function _lift_for_whilez_869(action_0, n_0, i_0) /* forall<a,e> (action : (ssize_t) -> e maybe<a>, n : ssize_t, i : ssize_t) -> e maybe<a> */  { tailcall: while(1)
{
  if ((i_0 < n_0)) {
    ...
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10035_0 /* maybe<664> */ ) {
        return _mlift_lift_for_whilez_869_10048(action_0, i_0, n_0, _y_x10035_0);
      });
    }
    else {
      if (x_0_10064 === null) {
...
export function foreach_while(v, f) /* forall<a,b,e> (v : vector<a>, f : (a) -> e maybe<b>) -> e maybe<b> */  {
  ...
  var i = 0;
  return _lift_for_whilez_869(function(i_0 /* ssize_t */ ) {
      return f((v)[i_0]);
    }, n_10006, i);
}
...
export function map(v, f) /* forall<a,b,e> (v : vector<a>, f : (a) -> e b) -> e vector<b> */  {
  ...
  var x_10067 = _lift_forz_868(function(i_0 /* ssize_t */ ) {
       
      var x_10019 = (v)[i_0];
       
      var x_0_10070 = f(x_10019);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10042 /* 765 */ ) {
          return (w)[i_0] = _y_x10042;
        });
      }
      else {
