...
// monadic lift
export function _mlift_map_10008(_y_x10004) /* forall<a,e> (a) -> e maybe<a> */  {
  return $std_core_types.Just(_y_x10004);
}
...
export function map(m, f) /* forall<a,b,e> (m : maybe<a>, f : (a) -> e b) -> e maybe<b> */  {
  if (m === null) {
    ...
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10004 /* 183 */ ) {
        return $std_core_types.Just(_y_x10004);
      });
    }
    else {
