...
export function throw_exn(exn_0) /* forall<a> (exn : exception) -> exn a */  {
  ...
  var _x2 = ev_10030.hnd._brk_throw_exn;
  return _x2(ev_10030.marker, ev_10030, exn_0);
}
...
export function $throw(message, info) /* forall<a> (message : string, info : ? exception-info) -> exn a */  {
  ...
  var _x3 = ev_10033.hnd._brk_throw_exn;
  var _x4 = (info !== undefined) ? info : ExnError;
  return _x3(ev_10033.marker, ev_10033, Exception(message, _x4));
}
...
export function error_pattern(location, definition) /* forall<a> (location : string, definition : string) -> exn a */  {
  ...
  var _x5 = ev_10036.hnd._brk_throw_exn;
  return _x5(ev_10036.marker, ev_10036, Exception(message_10003, ExnPattern(location, definition)));
}
...
// monadic lift
export function _mlift_try_10028(_y_x10020) /* forall<a,e> (a) -> <exn|e> error<a> */  {
  return Ok(_y_x10020);
}
...
export function $try(action) /* forall<a,e> (action : () -> <exn|e> a) -> e error<a> */  {
  return _handle_exn(_Hnd_exn(0, function(m /* hnd/marker<678,error<677>> */ , ___wildcard_x638__16 /* hnd/ev<exn> */ , x /* exception */ ) {
      ...
      var x_0_10041 = action();
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10020 /* 677 */ ) {
          return Ok(_y_x10020);
        });
      }
      else {
...
export function untry(err) /* forall<a> (err : error<a>) -> exn a */  {
  if (err._tag === 1) {
    ...
    var _x6 = ev_10045.hnd._brk_throw_exn;
    return _x6(ev_10045.marker, ev_10045, err.exception);
  }
  else {
    return err.result;
  }
