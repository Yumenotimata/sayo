...
int64_t kk_std_num_int64_int_fs_uint64(kk_integer_t i, kk_context_t* _ctx) { /* (i : int) -> int64 */ 
  ...
  if (_match_x287) {
    _x_x301 = kk_integer_sub(i,(kk_integer_from_str("18446744073709551616", _ctx)),kk_context()); /*int*/
  }
  else {
    _x_x301 = i; /*int*/
  }
  return kk_std_num_int64_int64(_x_x301, _ctx);
}
...
kk_string_t kk_std_num_int64_show_hex(int64_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int64, width : ? int, use-capitals : ? bool, pre : ? string) -> string */ 
  kk_integer_t _x_x302 = kk_integer_from_int64(i,kk_context()); /*int*/
  ...
  if (kk_std_core_types__is_Optional(width, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x4, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(width, _ctx);
    _x_x305 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(width, _ctx);
    _x_x305 = kk_integer_from_small(1); /*int*/
  }
  _x_x304 = kk_integer_box(_x_x305, _ctx); /*7*/
  _x_x303 = kk_std_core_types__new_Optional(_x_x304, _ctx); /*? 7*/
  kk_std_core_types__optional _x_x306;
  kk_box_t _x_x307;
  bool _x_x308;
  if (kk_std_core_types__is_Optional(use_capitals, _ctx)) {
    kk_box_t _box_x6 = use_capitals._cons._Optional.value;
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x6);
    kk_std_core_types__optional_drop(use_capitals, _ctx);
    _x_x308 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(use_capitals, _ctx);
    _x_x308 = true; /*bool*/
  }
  _x_x307 = kk_bool_box(_x_x308); /*7*/
  _x_x306 = kk_std_core_types__new_Optional(_x_x307, _ctx); /*? 7*/
  kk_std_core_types__optional _x_x309;
  kk_box_t _x_x310;
  kk_string_t _x_x311;
  if (kk_std_core_types__is_Optional(pre, _ctx)) {
    kk_box_t _box_x8 = pre._cons._Optional.value;
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x8);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(pre, _ctx);
    _x_x311 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(pre, _ctx);
    kk_define_string_literal(, _s_x312, 2, "0x", _ctx)
    _x_x311 = kk_string_dup(_s_x312, _ctx); /*string*/
  }
  _x_x310 = kk_string_box(_x_x311); /*7*/
  _x_x309 = kk_std_core_types__new_Optional(_x_x310, _ctx); /*? 7*/
  return kk_std_core_show_show_hex(_x_x302, _x_x303, _x_x306, _x_x309, _ctx);
}
...
kk_string_t kk_std_num_int64_show_hex64(int64_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int64, width : ? int, use-capitals : ? bool, pre : ? string) -> string */ 
  kk_integer_t _x_x313 = kk_std_num_int64_int64_fs_uint(i, _ctx); /*int*/
  kk_std_core_types__optional _x_x314;
  kk_box_t _x_x315;
  kk_integer_t _x_x316;
  if (kk_std_core_types__is_Optional(width, _ctx)) {
    kk_box_t _box_x13 = width._cons._Optional.value;
    kk_integer_t _uniq_width_574 = kk_integer_unbox(_box_x13, _ctx);
    kk_integer_dup(_uniq_width_574, _ctx);
    kk_std_core_types__optional_drop(width, _ctx);
    _x_x316 = _uniq_width_574; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(width, _ctx);
    _x_x316 = kk_integer_from_small(16); /*int*/
  }
  _x_x315 = kk_integer_box(_x_x316, _ctx); /*7*/
  _x_x314 = kk_std_core_types__new_Optional(_x_x315, _ctx); /*? 7*/
  kk_std_core_types__optional _x_x317;
  kk_box_t _x_x318;
  bool _x_x319;
  if (kk_std_core_types__is_Optional(use_capitals, _ctx)) {
    kk_box_t _box_x15 = use_capitals._cons._Optional.value;
    bool _uniq_use_capitals_578 = kk_bool_unbox(_box_x15);
    kk_std_core_types__optional_drop(use_capitals, _ctx);
    _x_x319 = _uniq_use_capitals_578; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(use_capitals, _ctx);
    _x_x319 = true; /*bool*/
  }
  _x_x318 = kk_bool_box(_x_x319); /*7*/
  _x_x317 = kk_std_core_types__new_Optional(_x_x318, _ctx); /*? 7*/
  kk_std_core_types__optional _x_x320;
  kk_box_t _x_x321;
  kk_string_t _x_x322;
  if (kk_std_core_types__is_Optional(pre, _ctx)) {
    kk_box_t _box_x17 = pre._cons._Optional.value;
    kk_string_t _uniq_pre_582 = kk_string_unbox(_box_x17);
    kk_string_dup(_uniq_pre_582, _ctx);
    kk_std_core_types__optional_drop(pre, _ctx);
    _x_x322 = _uniq_pre_582; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(pre, _ctx);
    kk_define_string_literal(, _s_x323, 2, "0x", _ctx)
    _x_x322 = kk_string_dup(_s_x323, _ctx); /*string*/
  }
  _x_x321 = kk_string_box(_x_x322); /*7*/
  _x_x320 = kk_std_core_types__new_Optional(_x_x321, _ctx); /*? 7*/
  return kk_std_core_show_show_hex(_x_x313, _x_x314, _x_x317, _x_x320, _ctx);
}
...
int64_t kk_std_num_int64_abs(int64_t i, kk_context_t* _ctx) { /* (i : int64) -> exn int64 */ 
  ...
  if (_x_x1_10209) {
    ...
    if (_match_x279) {
      ...
      int64_t x_0;
      int64_t _x_x329 = (KK_I64(0)); /*int64*/
      x_0 = (int64_t)((uint64_t)_x_x329 - (uint64_t)i); /*int64*/
    ...
    }
    {
      ...
      kk_box_t _x_x330;
      {
        struct kk_std_core_hnd_Ev* _con_x331 = kk_std_core_hnd__as_Ev(ev_10219, _ctx);
        kk_box_t _box_x22 = _con_x331->hnd;
        int32_t m = _con_x331->marker;
        ...
        kk_std_core_hnd__clause1 _brw_x282 = kk_std_core_exn__select_throw_exn(h, _ctx); /*hnd/clause1<exception,403,exn,404,405>*/;
        kk_std_core_exn__exn_drop(h, _ctx);
        _match_x280 = _brw_x282; /*hnd/clause1<exception,403,exn,404,405>*/
        {
          kk_function_t _fun_unbox_x26 = _match_x280.clause;
          kk_box_t _x_x332;
          kk_std_core_exn__exception _x_x333;
          kk_string_t _x_x334;
          kk_define_string_literal(, _s_x335, 79, "std/num/int64/abs: cannot make min-int64 into a positive int64 without overflow", _ctx)
          _x_x334 = kk_string_dup(_s_x335, _ctx); /*string*/
          kk_std_core_exn__exception_info _x_x336;
          ...
          if (kk_std_core_types__is_Optional(_match_x281, _ctx)) {
            ...
            _x_x336 = _uniq_info_473; /*exception-info*/
          }
          else {
            kk_std_core_types__optional_drop(_match_x281, _ctx);
            _x_x336 = kk_std_core_exn__new_ExnError(_ctx); /*exception-info*/
          }
          _x_x333 = kk_std_core_exn__new_Exception(_x_x334, _x_x336, _ctx); /*exception*/
          _x_x332 = kk_std_core_exn__exception_box(_x_x333, _ctx); /*45*/
          _x_x330 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x26, (_fun_unbox_x26, m, ev_10219, _x_x332, _ctx), _ctx); /*46*/
        }
      }
      return kk_int64_unbox(_x_x330, KK_OWNED, _ctx);
    }
  }
  {
    return i;
...
int64_t kk_std_num_int64_abs0(int64_t i, kk_context_t* _ctx) { /* (i : int64) -> int64 */ 
  ...
  if (b_10011) {
    ...
    if (_match_x278) {
      int64_t _x_x337 = (KK_I64(0)); /*int64*/
      return (int64_t)((uint64_t)_x_x337 - (uint64_t)i);
    }
    {
      return (KK_I64(0));
    }
...
int64_t kk_std_num_int64_cdiv(int64_t i, int64_t j, kk_context_t* _ctx) { /* (i : int64, j : int64) -> exn int64 */ 
  ...
  if (_match_x267) {
    ...
    kk_box_t _x_x344;
    {
      struct kk_std_core_hnd_Ev* _con_x345 = kk_std_core_hnd__as_Ev(ev_10222, _ctx);
      kk_box_t _box_x31 = _con_x345->hnd;
      int32_t m = _con_x345->marker;
      kk_std_core_exn__exn h = kk_std_core_exn__exn_unbox(_box_x31, KK_BORROWED, _ctx);
      kk_std_core_exn__exn_dup(h, _ctx);
      kk_std_core_hnd__clause1 _match_x273;
      kk_std_core_hnd__clause1 _brw_x275 = kk_std_core_exn__select_throw_exn(h, _ctx); /*hnd/clause1<exception,403,exn,404,405>*/;
      kk_std_core_exn__exn_drop(h, _ctx);
      _match_x273 = _brw_x275; /*hnd/clause1<exception,403,exn,404,405>*/
      {
        kk_function_t _fun_unbox_x35 = _match_x273.clause;
        kk_box_t _x_x346;
        kk_std_core_exn__exception _x_x347;
        kk_string_t _x_x348;
        kk_define_string_literal(, _s_x349, 36, "std/num/int64/cdiv: division by zero", _ctx)
        _x_x348 = kk_string_dup(_s_x349, _ctx); /*string*/
        kk_std_core_exn__exception_info _x_x350;
        ...
        if (kk_std_core_types__is_Optional(_match_x274, _ctx)) {
          ...
          _x_x350 = _uniq_info_473; /*exception-info*/
        }
        else {
          kk_std_core_types__optional_drop(_match_x274, _ctx);
          _x_x350 = kk_std_core_exn__new_ExnError(_ctx); /*exception-info*/
        }
        _x_x347 = kk_std_core_exn__new_Exception(_x_x348, _x_x350, _ctx); /*exception*/
        _x_x346 = kk_std_core_exn__exception_box(_x_x347, _ctx); /*45*/
        _x_x344 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x35, (_fun_unbox_x35, m, ev_10222, _x_x346, _ctx), _ctx); /*46*/
      }
    }
    return kk_int64_unbox(_x_x344, KK_OWNED, _ctx);
  }
  {
    kk_evv_t w = kk_evv_swap_create0(kk_context()); /*hnd/evv<exn>*/;
    ...
    if (_match_x268) {
      ...
      if (_match_x269) {
        ...
        kk_box_t _x_x351;
        {
          struct kk_std_core_hnd_Ev* _con_x352 = kk_std_core_hnd__as_Ev(ev_0_10227, _ctx);
          kk_box_t _box_x40 = _con_x352->hnd;
          int32_t m_0 = _con_x352->marker;
          ...
          kk_std_core_hnd__clause1 _brw_x272 = kk_std_core_exn__select_throw_exn(h_0, _ctx); /*hnd/clause1<exception,403,exn,404,405>*/;
          kk_std_core_exn__exn_drop(h_0, _ctx);
          _match_x270 = _brw_x272; /*hnd/clause1<exception,403,exn,404,405>*/
          {
            kk_function_t _fun_unbox_x44 = _match_x270.clause;
            kk_box_t _x_x353;
            kk_std_core_exn__exception _x_x354;
            kk_string_t _x_x355;
            kk_define_string_literal(, _s_x356, 66, "std/num/int64/cdiv: division overflow in cdiv(min-int64, -1.int64)", _ctx)
            _x_x355 = kk_string_dup(_s_x356, _ctx); /*string*/
            kk_std_core_exn__exception_info _x_x357;
            ...
            if (kk_std_core_types__is_Optional(_match_x271, _ctx)) {
              ...
              _x_x357 = _uniq_info_473_0; /*exception-info*/
            }
            else {
              kk_std_core_types__optional_drop(_match_x271, _ctx);
              _x_x357 = kk_std_core_exn__new_ExnError(_ctx); /*exception-info*/
            }
            _x_x354 = kk_std_core_exn__new_Exception(_x_x355, _x_x357, _ctx); /*exception*/
            _x_x353 = kk_std_core_exn__exception_box(_x_x354, _ctx); /*45*/
            _x_x351 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x44, (_fun_unbox_x44, m_0, ev_0_10227, _x_x353, _ctx), _ctx); /*46*/
          }
        }
...
int64_t kk_std_num_int64_cmod(int64_t i, int64_t j, kk_context_t* _ctx) { /* (i : int64, j : int64) -> exn int64 */ 
  ...
  if (_match_x258) {
    ...
    kk_box_t _x_x358;
    {
      struct kk_std_core_hnd_Ev* _con_x359 = kk_std_core_hnd__as_Ev(ev_10230, _ctx);
      kk_box_t _box_x49 = _con_x359->hnd;
      int32_t m = _con_x359->marker;
      kk_std_core_exn__exn h = kk_std_core_exn__exn_unbox(_box_x49, KK_BORROWED, _ctx);
      kk_std_core_exn__exn_dup(h, _ctx);
      kk_std_core_hnd__clause1 _match_x264;
      kk_std_core_hnd__clause1 _brw_x266 = kk_std_core_exn__select_throw_exn(h, _ctx); /*hnd/clause1<exception,403,exn,404,405>*/;
      kk_std_core_exn__exn_drop(h, _ctx);
      _match_x264 = _brw_x266; /*hnd/clause1<exception,403,exn,404,405>*/
      {
        kk_function_t _fun_unbox_x53 = _match_x264.clause;
        kk_box_t _x_x360;
        kk_std_core_exn__exception _x_x361;
        kk_string_t _x_x362;
        kk_define_string_literal(, _s_x363, 35, "std/num/int64/cmod: modulus by zero", _ctx)
        _x_x362 = kk_string_dup(_s_x363, _ctx); /*string*/
        kk_std_core_exn__exception_info _x_x364;
        ...
        if (kk_std_core_types__is_Optional(_match_x265, _ctx)) {
          ...
          _x_x364 = _uniq_info_473; /*exception-info*/
        }
        else {
          kk_std_core_types__optional_drop(_match_x265, _ctx);
          _x_x364 = kk_std_core_exn__new_ExnError(_ctx); /*exception-info*/
        }
        _x_x361 = kk_std_core_exn__new_Exception(_x_x362, _x_x364, _ctx); /*exception*/
        _x_x360 = kk_std_core_exn__exception_box(_x_x361, _ctx); /*45*/
        _x_x358 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x53, (_fun_unbox_x53, m, ev_10230, _x_x360, _ctx), _ctx); /*46*/
      }
    }
    return kk_int64_unbox(_x_x358, KK_OWNED, _ctx);
  }
  {
    kk_evv_t w = kk_evv_swap_create0(kk_context()); /*hnd/evv<exn>*/;
    int64_t x_0 = (KK_I64(-1)); /*int64*/;
    ...
    if (_match_x259) {
      ...
      if (_match_x260) {
        ...
        kk_box_t _x_x365;
        {
          struct kk_std_core_hnd_Ev* _con_x366 = kk_std_core_hnd__as_Ev(ev_0_10235, _ctx);
          kk_box_t _box_x58 = _con_x366->hnd;
          int32_t m_0 = _con_x366->marker;
          kk_std_core_exn__exn h_0 = kk_std_core_exn__exn_unbox(_box_x58, KK_BORROWED, _ctx);
          kk_std_core_exn__exn_dup(h_0, _ctx);
          kk_std_core_hnd__clause1 _match_x261;
          kk_std_core_hnd__clause1 _brw_x263 = kk_std_core_exn__select_throw_exn(h_0, _ctx); /*hnd/clause1<exception,403,exn,404,405>*/;
          kk_std_core_exn__exn_drop(h_0, _ctx);
          _match_x261 = _brw_x263; /*hnd/clause1<exception,403,exn,404,405>*/
          {
            kk_function_t _fun_unbox_x62 = _match_x261.clause;
            kk_box_t _x_x367;
            kk_std_core_exn__exception _x_x368;
            kk_string_t _x_x369;
            kk_define_string_literal(, _s_x370, 65, "std/num/int64/cmod: modulus overflow in cmod(min-int64, -1.int64)", _ctx)
            _x_x369 = kk_string_dup(_s_x370, _ctx); /*string*/
            kk_std_core_exn__exception_info _x_x371;
            ...
            if (kk_std_core_types__is_Optional(_match_x262, _ctx)) {
              ...
              _x_x371 = _uniq_info_473_0; /*exception-info*/
            }
            else {
              kk_std_core_types__optional_drop(_match_x262, _ctx);
              _x_x371 = kk_std_core_exn__new_ExnError(_ctx); /*exception-info*/
            }
            _x_x368 = kk_std_core_exn__new_Exception(_x_x369, _x_x371, _ctx); /*exception*/
            _x_x367 = kk_std_core_exn__exception_box(_x_x368, _ctx); /*45*/
            _x_x365 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x62, (_fun_unbox_x62, m_0, ev_0_10235, _x_x367, _ctx), _ctx); /*46*/
          }
        }
        return kk_int64_unbox(_x_x365, KK_OWNED, _ctx);
      }
      {
        return i % j;
      }
  ...
  }
  {
    ...
    if (_match_x252) {
      ...
      }
      {
        ...
        int64_t r = x % y; /*int64*/;
        bool _match_x256;
        int64_t _x_x375 = (KK_I64(0)); /*int64*/
        _match_x256 = (r >= _x_x375); /*bool*/
        if (_match_x256) {
          return q;
        }
        {
          ...
          _match_x257 = (y > _x_x376); /*bool*/
          if (_match_x257) {
            int64_t _x_x377 = (KK_I64(1)); /*int64*/
            return (int64_t)((uint64_t)q - (uint64_t)_x_x377);
          }
          {
            int64_t _x_x378 = (KK_I64(1)); /*int64*/
            return (int64_t)((uint64_t)q + (uint64_t)_x_x378);
          }
        }
      }
    }
    {
      ...
      bool _match_x253;
      int64_t _x_x379 = (KK_I64(0)); /*int64*/
      _match_x253 = (r_0 >= _x_x379); /*bool*/
      if (_match_x253) {
        return q_0;
      }
      {
        ...
        _match_x254 = (y > _x_x380); /*bool*/
        if (_match_x254) {
          int64_t _x_x381 = (KK_I64(1)); /*int64*/
          return (int64_t)((uint64_t)q_0 - (uint64_t)_x_x381);
        }
        {
          int64_t _x_x382 = (KK_I64(1)); /*int64*/
          return (int64_t)((uint64_t)q_0 + (uint64_t)_x_x382);
        }
      }
    }
  }
...
int64_t kk_std_num_int64__lp__perc__rp_(int64_t x, int64_t y, kk_context_t* _ctx) { /* (x : int64, y : int64) -> int64 */ 
  bool _match_x244;
  int64_t _x_x383 = (KK_I64(0)); /*int64*/
  _match_x244 = (y == _x_x383); /*bool*/
  if (_match_x244) {
    return x;
  }
  {
    bool _match_x245;
    int64_t _x_x384 = (KK_I64(-1)); /*int64*/
    _match_x245 = (y == _x_x384); /*bool*/
    if (_match_x245) {
    ...
    }
    {
      int64_t r_0 = x % y; /*int64*/;
      bool _match_x246;
      int64_t _x_x387 = (KK_I64(0)); /*int64*/
      _match_x246 = (r_0 >= _x_x387); /*bool*/
      if (_match_x246) {
        return r_0;
      }
      {
...
kk_std_core_types__tuple2 kk_std_num_int64_divmod(int64_t x, int64_t y, kk_context_t* _ctx) { /* (x : int64, y : int64) -> (int64, int64) */ 
  ...
  }
  {
    ...
    if (_match_x238) {
      ...
      }
      {
        ...
        }
        {
          ...
          _match_x243 = (y > _x_x391); /*bool*/
          if (_match_x243) {
            int64_t _b_x73_89;
            int64_t _x_x392 = (KK_I64(1)); /*int64*/
            _b_x73_89 = (int64_t)((uint64_t)q - (uint64_t)_x_x392); /*int64*/
          ...
          }
          {
            ...
            _b_x75_91 = (int64_t)((uint64_t)q + (uint64_t)_x_x393); /*int64*/
    ...
    }
    {
      ...
      int64_t r_0 = x % y; /*int64*/;
      bool _match_x239;
      int64_t _x_x394 = (KK_I64(0)); /*int64*/
      _match_x239 = (r_0 >= _x_x394); /*bool*/
      if (_match_x239) {
      ...
      }
      {
        ...
        _match_x240 = (y > _x_x395); /*bool*/
        if (_match_x240) {
          int64_t _b_x79_95;
          int64_t _x_x396 = (KK_I64(1)); /*int64*/
          _b_x79_95 = (int64_t)((uint64_t)q_0 - (uint64_t)_x_x396); /*int64*/
        ...
        }
        {
          ...
          _b_x81_97 = (int64_t)((uint64_t)q_0 + (uint64_t)_x_x397); /*int64*/
...
kk_box_t kk_std_num_int64_range_fs__mlift_fold_int64_10213(int64_t end, kk_function_t f, int64_t start, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e> (end : int64, f : (int64, a) -> e a, start : int64, x : a) -> e a */ 
  int64_t _x_x398;
  int64_t _x_x399 = (KK_I64(1)); /*int64*/
  _x_x398 = (int64_t)((uint64_t)start + (uint64_t)_x_x399); /*int64*/
  return kk_std_num_int64_range_fs_fold_int64(_x_x398, end, x, f, _ctx);
}


// lift anonymous function
struct kk_std_num_int64_range_fs_fold_int64_fun401__t {
  struct kk_function_s _base;
  kk_function_t f_0;
  int64_t end_0;
  int64_t start_0;
};
static kk_box_t kk_std_num_int64_range_fs_fold_int64_fun401(kk_function_t _fself, kk_box_t x_1, kk_context_t* _ctx);
static kk_function_t kk_std_num_int64_range_fs_new_fold_int64_fun401(kk_function_t f_0, int64_t end_0, int64_t start_0, kk_context_t* _ctx) {
  struct kk_std_num_int64_range_fs_fold_int64_fun401__t* _self = kk_function_alloc_as(struct kk_std_num_int64_range_fs_fold_int64_fun401__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_num_int64_range_fs_fold_int64_fun401, kk_context());
  _self->f_0 = f_0;
  _self->end_0 = end_0;
...
static kk_box_t kk_std_num_int64_range_fs_fold_int64_fun401(kk_function_t _fself, kk_box_t x_1, kk_context_t* _ctx) {
  struct kk_std_num_int64_range_fs_fold_int64_fun401__t* _self = kk_function_as(struct kk_std_num_int64_range_fs_fold_int64_fun401__t*, _fself, _ctx);
  kk_function_t f_0 = _self->f_0; /* (int64, 2000) -> 2001 2000 */
...
kk_box_t kk_std_num_int64_range_fs_fold_int64(int64_t start_0, int64_t end_0, kk_box_t init, kk_function_t f_0, kk_context_t* _ctx) { /* forall<a,e> (start : int64, end : int64, init : a, f : (int64, a) -> e a) -> e a */ 
  ...
  {
    kk_box_t x_0_10238;
    kk_function_t _x_x400 = kk_function_dup(f_0, _ctx); /*(int64, 2000) -> 2001 2000*/
    x_0_10238 = kk_function_call(kk_box_t, (kk_function_t, int64_t, kk_box_t, kk_context_t*), _x_x400, (_x_x400, start_0, init, _ctx), _ctx); /*2000*/
    if (kk_yielding(kk_context())) {
      kk_box_drop(x_0_10238, _ctx);
      return kk_std_core_hnd_yield_extend(kk_std_num_int64_range_fs_new_fold_int64_fun401(f_0, end_0, start_0, _ctx), _ctx);
    }
    { // tailcall
      int64_t _x_x402;
      int64_t _x_x403 = (KK_I64(1)); /*int64*/
      _x_x402 = (int64_t)((uint64_t)start_0 + (uint64_t)_x_x403); /*int64*/
      start_0 = _x_x402;
      init = x_0_10238;
      goto kk__tailcall;
    }
...
kk_std_core_types__maybe kk_std_num_int64_range_fs__mlift_lift_for_while64_2551_10214(kk_function_t action, int64_t end, int64_t i, kk_std_core_types__maybe _y_x10195, kk_context_t* _ctx) { /* forall<a,e> (action : (int64) -> e maybe<a>, end : int64, i : int64, maybe<a>) -> e maybe<a> */ 
  if (kk_std_core_types__is_Nothing(_y_x10195, _ctx)) {
    int64_t i_0_10029;
    int64_t _x_x406 = (KK_I64(1)); /*int64*/
    i_0_10029 = (int64_t)((uint64_t)i + (uint64_t)_x_x406); /*int64*/
    return kk_std_num_int64_range_fs__lift_for_while64_2551(action, end, i_0_10029, _ctx);
  }
  {
...
// lift anonymous function
struct kk_std_num_int64_range_fs__lift_for_while64_2551_fun409__t {
  struct kk_function_s _base;
  kk_function_t action_0;
  int64_t end_0;
  int64_t i_0;
};
static kk_box_t kk_std_num_int64_range_fs__lift_for_while64_2551_fun409(kk_function_t _fself, kk_box_t _b_x100, kk_context_t* _ctx);
static kk_function_t kk_std_num_int64_range_fs__new_lift_for_while64_2551_fun409(kk_function_t action_0, int64_t end_0, int64_t i_0, kk_context_t* _ctx) {
  struct kk_std_num_int64_range_fs__lift_for_while64_2551_fun409__t* _self = kk_function_alloc_as(struct kk_std_num_int64_range_fs__lift_for_while64_2551_fun409__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_num_int64_range_fs__lift_for_while64_2551_fun409, kk_context());
...
static kk_box_t kk_std_num_int64_range_fs__lift_for_while64_2551_fun409(kk_function_t _fself, kk_box_t _b_x100, kk_context_t* _ctx) {
  struct kk_std_num_int64_range_fs__lift_for_while64_2551_fun409__t* _self = kk_function_as(struct kk_std_num_int64_range_fs__lift_for_while64_2551_fun409__t*, _fself, _ctx);
  kk_function_t action_0 = _self->action_0; /* (int64) -> 2076 maybe<2075> */
  int64_t end_0 = _self->end_0; /* int64 */
  ...
  kk_std_core_types__maybe _y_x10195_0_102 = kk_std_core_types__maybe_unbox(_b_x100, KK_OWNED, _ctx); /*maybe<2075>*/;
  kk_std_core_types__maybe _x_x410 = kk_std_num_int64_range_fs__mlift_lift_for_while64_2551_10214(action_0, end_0, i_0, _y_x10195_0_102, _ctx); /*maybe<2075>*/
  return kk_std_core_types__maybe_box(_x_x410, _ctx);
}
...
kk_std_core_types__maybe kk_std_num_int64_range_fs__lift_for_while64_2551(kk_function_t action_0, int64_t end_0, int64_t i_0, kk_context_t* _ctx) { /* forall<a,e> (action : (int64) -> e maybe<a>, end : int64, i : int64) -> e maybe<a> */ 
  ...
  if (_match_x233) {
    ...
    kk_function_t _x_x407 = kk_function_dup(action_0, _ctx); /*(int64) -> 2076 maybe<2075>*/
    x_0_10241 = kk_function_call(kk_std_core_types__maybe, (kk_function_t, int64_t, kk_context_t*), _x_x407, (_x_x407, i_0, _ctx), _ctx); /*maybe<2075>*/
    if (kk_yielding(kk_context())) {
      kk_std_core_types__maybe_drop(x_0_10241, _ctx);
      kk_box_t _x_x408 = kk_std_core_hnd_yield_extend(kk_std_num_int64_range_fs__new_lift_for_while64_2551_fun409(action_0, end_0, i_0, _ctx), _ctx); /*2978*/
      return kk_std_core_types__maybe_unbox(_x_x408, KK_OWNED, _ctx);
    }
    if (kk_std_core_types__is_Nothing(x_0_10241, _ctx)) {
      int64_t i_0_10029_0;
      int64_t _x_x411 = (KK_I64(1)); /*int64*/
      i_0_10029_0 = (int64_t)((uint64_t)i_0 + (uint64_t)_x_x411); /*int64*/
      { // tailcall
        i_0 = i_0_10029_0;
        goto kk__tailcall;
      }
...
kk_std_core_types__list kk_std_num_int64__trmc_list64(int64_t lo_0, int64_t hi_0, kk_std_core_types__cctx _acc, kk_context_t* _ctx) { /* (lo : int64, hi : int64, ctx<list<int64>>) -> list<int64> */ 
  ...
  if (_match_x232) {
    ...
    { // tailcall
      ...
      _x_x415 = (int64_t)((uint64_t)lo_0 + (uint64_t)_x_x416); /*int64*/
      kk_std_core_types__cctx _x_x417 = kk_cctx_extend_linear(_acc,(kk_std_core_types__list_box(_trmc_x10177, _ctx)),_b_x112_117,kk_context()); /*ctx<0>*/
      lo_0 = _x_x415;
      _acc = _x_x417;
      goto kk__tailcall;
    }
  ...
  {
    kk_box_t _x_x418 = kk_cctx_apply_linear(_acc,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*-1*/
    return kk_std_core_types__list_unbox(_x_x418, KK_OWNED, _ctx);
  }
}
...
kk_std_core_types__list kk_std_num_int64_list64(int64_t lo_0_0, int64_t hi_0_0, kk_context_t* _ctx) { /* (lo : int64, hi : int64) -> list<int64> */ 
  kk_std_core_types__cctx _x_x419 = kk_cctx_empty(kk_context()); /*ctx<0>*/
  return kk_std_num_int64__trmc_list64(lo_0_0, hi_0_0, _x_x419, _ctx);
}
...
int64_t kk_std_num_int64__unroll_sumacc64_10000(kk_std_core_types__list xs, int64_t acc, kk_context_t* _ctx) { /* (xs : list<int64>, acc : int64) -> int64 */ 
  ...
  if (kk_std_core_types__is_Cons(xs, _ctx)) {
    struct kk_std_core_types_Cons* _con_x420 = kk_std_core_types__as_Cons(xs, _ctx);
    kk_box_t _box_x123 = _con_x420->head;
    kk_std_core_types__list xx = _con_x420->tail;
    ...
    { // tailcall
      int64_t _x_x421 = (int64_t)((uint64_t)acc + (uint64_t)x); /*int64*/
      xs = xx;
      acc = _x_x421;
      goto kk__tailcall;
    }
...
kk_string_t kk_std_num_int64_test_prefix_sum(kk_context_t* _ctx) { /* () -> string */ 
  ...
  int64_t i_10036;
  int64_t _x_x422 = (KK_I64(-1)); /*int64*/
  i_10036 = (int64_t)kk_clmul64((uint64_t)x,(uint64_t)_x_x422); /*int64*/
  kk_integer_t _x_x423 = kk_integer_from_int64(i_10036,kk_context()); /*int*/
  ...
  if (kk_std_core_types__is_Optional(_match_x231, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x124, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x231, _ctx);
    _x_x426 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x231, _ctx);
    _x_x426 = kk_integer_from_small(1); /*int*/
  }
  _x_x425 = kk_integer_box(_x_x426, _ctx); /*7*/
  _x_x424 = kk_std_core_types__new_Optional(_x_x425, _ctx); /*? 7*/
  kk_std_core_types__optional _x_x427;
  kk_box_t _x_x428;
  bool _x_x429;
  ...
  if (kk_std_core_types__is_Optional(_match_x230, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x126);
    kk_std_core_types__optional_drop(_match_x230, _ctx);
    _x_x429 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x230, _ctx);
    _x_x429 = true; /*bool*/
  }
  _x_x428 = kk_bool_box(_x_x429); /*7*/
  _x_x427 = kk_std_core_types__new_Optional(_x_x428, _ctx); /*? 7*/
  kk_std_core_types__optional _x_x430;
  kk_box_t _x_x431;
  kk_string_t _x_x432;
  ...
  if (kk_std_core_types__is_Optional(_match_x229, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x128);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x229, _ctx);
    _x_x432 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x229, _ctx);
    kk_define_string_literal(, _s_x433, 2, "0x", _ctx)
    _x_x432 = kk_string_dup(_s_x433, _ctx); /*string*/
  }
  _x_x431 = kk_string_box(_x_x432); /*7*/
  _x_x430 = kk_std_core_types__new_Optional(_x_x431, _ctx); /*? 7*/
  return kk_std_core_show_show_hex(_x_x423, _x_x424, _x_x427, _x_x430, _ctx);
}
...
kk_string_t kk_std_num_int64_test_bit_spread1(kk_context_t* _ctx) { /* () -> string */ 
  ...
  kk_integer_t _x_x434 = kk_integer_from_int64(i_10040,kk_context()); /*int*/
  ...
  if (kk_std_core_types__is_Optional(_match_x228, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x133, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x228, _ctx);
    _x_x437 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x228, _ctx);
    _x_x437 = kk_integer_from_small(1); /*int*/
  }
  _x_x436 = kk_integer_box(_x_x437, _ctx); /*7*/
  _x_x435 = kk_std_core_types__new_Optional(_x_x436, _ctx); /*? 7*/
  kk_std_core_types__optional _x_x438;
  kk_box_t _x_x439;
  bool _x_x440;
  ...
  if (kk_std_core_types__is_Optional(_match_x227, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x135);
    kk_std_core_types__optional_drop(_match_x227, _ctx);
    _x_x440 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x227, _ctx);
    _x_x440 = true; /*bool*/
  }
  _x_x439 = kk_bool_box(_x_x440); /*7*/
  _x_x438 = kk_std_core_types__new_Optional(_x_x439, _ctx); /*? 7*/
  kk_std_core_types__optional _x_x441;
  kk_box_t _x_x442;
  kk_string_t _x_x443;
  ...
  if (kk_std_core_types__is_Optional(_match_x226, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x137);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x226, _ctx);
    _x_x443 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x226, _ctx);
    kk_define_string_literal(, _s_x444, 2, "0x", _ctx)
    _x_x443 = kk_string_dup(_s_x444, _ctx); /*string*/
  }
  _x_x442 = kk_string_box(_x_x443); /*7*/
  _x_x441 = kk_std_core_types__new_Optional(_x_x442, _ctx); /*? 7*/
  return kk_std_core_show_show_hex(_x_x434, _x_x435, _x_x438, _x_x441, _ctx);
}
...
kk_string_t kk_std_num_int64_test_bit_spread2(kk_context_t* _ctx) { /* () -> string */ 
  ...
  kk_integer_t _x_x445 = kk_integer_from_int64(i_10044,kk_context()); /*int*/
  ...
  if (kk_std_core_types__is_Optional(_match_x225, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x142, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x225, _ctx);
    _x_x448 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x225, _ctx);
    _x_x448 = kk_integer_from_small(1); /*int*/
  }
  _x_x447 = kk_integer_box(_x_x448, _ctx); /*7*/
  _x_x446 = kk_std_core_types__new_Optional(_x_x447, _ctx); /*? 7*/
  kk_std_core_types__optional _x_x449;
  kk_box_t _x_x450;
  bool _x_x451;
  ...
  if (kk_std_core_types__is_Optional(_match_x224, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x144);
    kk_std_core_types__optional_drop(_match_x224, _ctx);
    _x_x451 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x224, _ctx);
    _x_x451 = true; /*bool*/
  }
  _x_x450 = kk_bool_box(_x_x451); /*7*/
  _x_x449 = kk_std_core_types__new_Optional(_x_x450, _ctx); /*? 7*/
  kk_std_core_types__optional _x_x452;
  kk_box_t _x_x453;
  kk_string_t _x_x454;
  ...
  if (kk_std_core_types__is_Optional(_match_x223, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x146);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x223, _ctx);
    _x_x454 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x223, _ctx);
    kk_define_string_literal(, _s_x455, 2, "0x", _ctx)
    _x_x454 = kk_string_dup(_s_x455, _ctx); /*string*/
  }
  _x_x453 = kk_string_box(_x_x454); /*7*/
  _x_x452 = kk_std_core_types__new_Optional(_x_x453, _ctx); /*? 7*/
  return kk_std_core_show_show_hex(_x_x445, _x_x446, _x_x449, _x_x452, _ctx);
}
...
kk_string_t kk_std_num_int64_test_clmulr1(kk_context_t* _ctx) { /* () -> string */ 
  ...
  i_0_10052 = _x_x458 | _x_x459; /*int64*/
  ...
  if (kk_std_core_types__is_Optional(_match_x222, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x151, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x222, _ctx);
    _b_x152_163 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x222, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x221, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x153);
    kk_std_core_types__optional_drop(_match_x221, _ctx);
    _b_x154_164 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x221, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x220, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x155);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x220, _ctx);
    _b_x156_165 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x220, _ctx);
    kk_define_string_literal(, _s_x460, 2, "0x", _ctx)
    _b_x156_165 = kk_string_dup(_s_x460, _ctx); /*string*/
  }
  kk_string_t _x_x461;
  kk_integer_t _x_x462 = kk_integer_from_int64(i_10048,kk_context()); /*int*/
  kk_std_core_types__optional _x_x463 = kk_std_core_types__new_Optional(kk_integer_box(_b_x152_163, _ctx), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x464 = kk_std_core_types__new_Optional(kk_bool_box(_b_x154_164), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x465 = kk_std_core_types__new_Optional(kk_string_box(_b_x156_165), _ctx); /*? 7*/
  ...
  if (kk_std_core_types__is_Optional(_match_x219, _ctx)) {
    ...
    kk_integer_t _uniq_width_527_0 = kk_integer_unbox(_box_x157, _ctx);
    kk_integer_dup(_uniq_width_527_0, _ctx);
    kk_std_core_types__optional_drop(_match_x219, _ctx);
    _b_x158_166 = _uniq_width_527_0; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x219, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x218, _ctx)) {
    ...
    bool _uniq_use_capitals_531_0 = kk_bool_unbox(_box_x159);
    kk_std_core_types__optional_drop(_match_x218, _ctx);
    _b_x160_167 = _uniq_use_capitals_531_0; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x218, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x217, _ctx)) {
    ...
    kk_string_t _uniq_pre_535_0 = kk_string_unbox(_box_x161);
    kk_string_dup(_uniq_pre_535_0, _ctx);
    kk_std_core_types__optional_drop(_match_x217, _ctx);
    _b_x162_168 = _uniq_pre_535_0; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x217, _ctx);
    kk_define_string_literal(, _s_x467, 2, "0x", _ctx)
    _b_x162_168 = kk_string_dup(_s_x467, _ctx); /*string*/
  }
  kk_string_t _x_x468;
  kk_define_string_literal(, _s_x469, 4, " == ", _ctx)
  _x_x468 = kk_string_dup(_s_x469, _ctx); /*string*/
  kk_string_t _x_x470;
  kk_integer_t _x_x471 = kk_integer_from_int64(i_0_10052,kk_context()); /*int*/
  kk_std_core_types__optional _x_x472 = kk_std_core_types__new_Optional(kk_integer_box(_b_x158_166, _ctx), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x473 = kk_std_core_types__new_Optional(kk_bool_box(_b_x160_167), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x474 = kk_std_core_types__new_Optional(kk_string_box(_b_x162_168), _ctx); /*? 7*/
...
kk_string_t kk_std_num_int64_test_clmulr2(kk_context_t* _ctx) { /* () -> string */ 
  ...
  int64_t i_0_10061;
  int64_t _x_x475 = (int64_t)kk_clmul64((uint64_t)x,(uint64_t)x); /*int64*/
  int64_t _x_x476 = (int64_t)kk_clmulr64((uint64_t)x,(uint64_t)x); /*int64*/
  i_0_10061 = _x_x475 | _x_x476; /*int64*/
  ...
  if (kk_std_core_types__is_Optional(_match_x216, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x169, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x216, _ctx);
    _b_x170_181 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x216, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x215, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x171);
    kk_std_core_types__optional_drop(_match_x215, _ctx);
    _b_x172_182 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x215, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x214, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x173);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x214, _ctx);
    _b_x174_183 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x214, _ctx);
    kk_define_string_literal(, _s_x477, 2, "0x", _ctx)
    _b_x174_183 = kk_string_dup(_s_x477, _ctx); /*string*/
  }
  kk_string_t _x_x478;
  kk_integer_t _x_x479 = kk_integer_from_int64(i_10057,kk_context()); /*int*/
  kk_std_core_types__optional _x_x480 = kk_std_core_types__new_Optional(kk_integer_box(_b_x170_181, _ctx), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x481 = kk_std_core_types__new_Optional(kk_bool_box(_b_x172_182), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x482 = kk_std_core_types__new_Optional(kk_string_box(_b_x174_183), _ctx); /*? 7*/
  _x_x478 = kk_std_core_show_show_hex(_x_x479, _x_x480, _x_x481, _x_x482, _ctx); /*string*/
  kk_string_t _x_x483;
  ...
  if (kk_std_core_types__is_Optional(_match_x213, _ctx)) {
    ...
    kk_integer_t _uniq_width_527_0 = kk_integer_unbox(_box_x175, _ctx);
    kk_integer_dup(_uniq_width_527_0, _ctx);
    kk_std_core_types__optional_drop(_match_x213, _ctx);
    _b_x176_184 = _uniq_width_527_0; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x213, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x212, _ctx)) {
    ...
    bool _uniq_use_capitals_531_0 = kk_bool_unbox(_box_x177);
    kk_std_core_types__optional_drop(_match_x212, _ctx);
    _b_x178_185 = _uniq_use_capitals_531_0; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x212, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x211, _ctx)) {
    ...
    kk_string_t _uniq_pre_535_0 = kk_string_unbox(_box_x179);
    kk_string_dup(_uniq_pre_535_0, _ctx);
    kk_std_core_types__optional_drop(_match_x211, _ctx);
    _b_x180_186 = _uniq_pre_535_0; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x211, _ctx);
    kk_define_string_literal(, _s_x484, 2, "0x", _ctx)
    _b_x180_186 = kk_string_dup(_s_x484, _ctx); /*string*/
  }
  kk_string_t _x_x485;
  kk_define_string_literal(, _s_x486, 4, " == ", _ctx)
  _x_x485 = kk_string_dup(_s_x486, _ctx); /*string*/
  kk_string_t _x_x487;
  kk_integer_t _x_x488 = kk_integer_from_int64(i_0_10061,kk_context()); /*int*/
  kk_std_core_types__optional _x_x489 = kk_std_core_types__new_Optional(kk_integer_box(_b_x176_184, _ctx), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x490 = kk_std_core_types__new_Optional(kk_bool_box(_b_x178_185), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x491 = kk_std_core_types__new_Optional(kk_string_box(_b_x180_186), _ctx); /*? 7*/
  _x_x487 = kk_std_core_show_show_hex(_x_x488, _x_x489, _x_x490, _x_x491, _ctx); /*string*/
  _x_x483 = kk_std_core_types__lp__plus__plus__rp_(_x_x485, _x_x487, _ctx); /*string*/
  return kk_std_core_types__lp__plus__plus__rp_(_x_x478, _x_x483, _ctx);
}

kk_string_t kk_std_num_int64_test_clmulrev1(kk_context_t* _ctx) { /* () -> string */ 
  int64_t x = (KK_I64(305419896)); /*int64*/;
  int64_t y;
  int64_t _x_x495 = (KK_I64(2309737967)); /*int64*/
  y = kk_bits_bswap64(_x_x495); /*int64*/
  int64_t i_10066 = (int64_t)kk_clmulr64((uint64_t)x,(uint64_t)y); /*int64*/;
  int64_t i_0_10070;
  int64_t _x_x496;
  int64_t _x_x497 = kk_bits_reverse64(x); /*int64*/
  int64_t _x_x498 = kk_bits_reverse64(y); /*int64*/
  _x_x496 = (int64_t)kk_clmul64((uint64_t)_x_x497,(uint64_t)_x_x498); /*int64*/
  i_0_10070 = kk_bits_reverse64(_x_x496); /*int64*/
  ...
  if (kk_std_core_types__is_Optional(_match_x210, _ctx)) {
    ...
    kk_integer_t _uniq_width_527 = kk_integer_unbox(_box_x187, _ctx);
    kk_integer_dup(_uniq_width_527, _ctx);
    kk_std_core_types__optional_drop(_match_x210, _ctx);
    _b_x188_199 = _uniq_width_527; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x210, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x209, _ctx)) {
    ...
    bool _uniq_use_capitals_531 = kk_bool_unbox(_box_x189);
    kk_std_core_types__optional_drop(_match_x209, _ctx);
    _b_x190_200 = _uniq_use_capitals_531; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x209, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x208, _ctx)) {
    ...
    kk_string_t _uniq_pre_535 = kk_string_unbox(_box_x191);
    kk_string_dup(_uniq_pre_535, _ctx);
    kk_std_core_types__optional_drop(_match_x208, _ctx);
    _b_x192_201 = _uniq_pre_535; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x208, _ctx);
    kk_define_string_literal(, _s_x499, 2, "0x", _ctx)
    _b_x192_201 = kk_string_dup(_s_x499, _ctx); /*string*/
  }
  kk_string_t _x_x500;
  kk_integer_t _x_x501 = kk_integer_from_int64(i_10066,kk_context()); /*int*/
  kk_std_core_types__optional _x_x502 = kk_std_core_types__new_Optional(kk_integer_box(_b_x188_199, _ctx), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x503 = kk_std_core_types__new_Optional(kk_bool_box(_b_x190_200), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x504 = kk_std_core_types__new_Optional(kk_string_box(_b_x192_201), _ctx); /*? 7*/
  _x_x500 = kk_std_core_show_show_hex(_x_x501, _x_x502, _x_x503, _x_x504, _ctx); /*string*/
  kk_string_t _x_x505;
  ...
  if (kk_std_core_types__is_Optional(_match_x207, _ctx)) {
    ...
    kk_integer_t _uniq_width_527_0 = kk_integer_unbox(_box_x193, _ctx);
    kk_integer_dup(_uniq_width_527_0, _ctx);
    kk_std_core_types__optional_drop(_match_x207, _ctx);
    _b_x194_202 = _uniq_width_527_0; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x207, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x206, _ctx)) {
    ...
    bool _uniq_use_capitals_531_0 = kk_bool_unbox(_box_x195);
    kk_std_core_types__optional_drop(_match_x206, _ctx);
    _b_x196_203 = _uniq_use_capitals_531_0; /*bool*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x206, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x205, _ctx)) {
    ...
    kk_string_t _uniq_pre_535_0 = kk_string_unbox(_box_x197);
    kk_string_dup(_uniq_pre_535_0, _ctx);
    kk_std_core_types__optional_drop(_match_x205, _ctx);
    _b_x198_204 = _uniq_pre_535_0; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x205, _ctx);
    kk_define_string_literal(, _s_x506, 2, "0x", _ctx)
    _b_x198_204 = kk_string_dup(_s_x506, _ctx); /*string*/
  }
  kk_string_t _x_x507;
  kk_define_string_literal(, _s_x508, 4, " == ", _ctx)
  _x_x507 = kk_string_dup(_s_x508, _ctx); /*string*/
  kk_string_t _x_x509;
  kk_integer_t _x_x510 = kk_integer_from_int64(i_0_10070,kk_context()); /*int*/
  kk_std_core_types__optional _x_x511 = kk_std_core_types__new_Optional(kk_integer_box(_b_x194_202, _ctx), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x512 = kk_std_core_types__new_Optional(kk_bool_box(_b_x196_203), _ctx); /*? 7*/
  kk_std_core_types__optional _x_x513 = kk_std_core_types__new_Optional(kk_string_box(_b_x198_204), _ctx); /*? 7*/
  _x_x509 = kk_std_core_show_show_hex(_x_x510, _x_x511, _x_x512, _x_x513, _ctx); /*string*/
  _x_x505 = kk_std_core_types__lp__plus__plus__rp_(_x_x507, _x_x509, _ctx); /*string*/
  return kk_std_core_types__lp__plus__plus__rp_(_x_x500, _x_x505, _ctx);
}
