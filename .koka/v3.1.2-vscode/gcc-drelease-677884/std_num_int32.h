...
static inline int32_t kk_std_num_int32_hilo_fs_int32(int32_t hi_0, int32_t lo_0, kk_context_t* _ctx) { /* (hi : int32, lo : int32) -> int32 */ 
  int32_t _x_x198 = kk_shl32(hi_0,((KK_I32(16)))); /*int32*/
  int32_t _x_x199 = (lo_0 & ((KK_I32(65535)))); /*int32*/
  return (_x_x198 | _x_x199);
}
...
static inline kk_integer_t kk_std_num_int32_uint(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> int */ 
  bool _match_x197 = 0 > i; /*bool*/;
  if (_match_x197) {
    kk_integer_t y_10002 = kk_integer_from_int(i,kk_context()); /*int*/;
    return kk_integer_add((kk_integer_from_str("4294967296", _ctx)),y_10002,kk_context());
  }
  {
...
static inline kk_integer_t kk_std_num_int32_hilo_fs_int(kk_std_core_types__tuple2 _pat_x420__19, kk_context_t* _ctx) { /* ((int32, int32)) -> int */ 
  {
    kk_box_t _box_x0 = _pat_x420__19.fst;
    kk_box_t _box_x1 = _pat_x420__19.snd;
    int32_t hi_0 = kk_int32_unbox(_box_x0, KK_BORROWED, _ctx);
    int32_t lo_0 = kk_int32_unbox(_box_x1, KK_BORROWED, _ctx);
    kk_std_core_types__tuple2_drop(_pat_x420__19, _ctx);
    kk_integer_t x_10003;
    kk_integer_t _x_x200 = kk_integer_from_int(hi_0,kk_context()); /*int*/
    x_10003 = kk_integer_mul(_x_x200,(kk_integer_from_str("4294967296", _ctx)),kk_context()); /*int*/
    kk_integer_t y_10004 = kk_std_num_int32_uint(lo_0, _ctx); /*int*/;
...
static inline kk_integer_t kk_std_num_int32_hilo_fs_uint(kk_std_core_types__tuple2 _pat_x425__20, kk_context_t* _ctx) { /* ((int32, int32)) -> int */ 
  {
    kk_box_t _box_x2 = _pat_x425__20.fst;
    kk_box_t _box_x3 = _pat_x425__20.snd;
    int32_t hi_0 = kk_int32_unbox(_box_x2, KK_BORROWED, _ctx);
    int32_t lo_0 = kk_int32_unbox(_box_x3, KK_BORROWED, _ctx);
    kk_std_core_types__tuple2_drop(_pat_x425__20, _ctx);
    kk_integer_t x_10005;
    kk_integer_t _x_x201 = kk_std_num_int32_uint(hi_0, _ctx); /*int*/
    x_10005 = kk_integer_mul(_x_x201,(kk_integer_from_str("4294967296", _ctx)),kk_context()); /*int*/
    kk_integer_t y_10006 = kk_std_num_int32_uint(lo_0, _ctx); /*int*/;
...
static inline kk_string_t kk_std_num_int32_show(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> string */ 
  kk_integer_t _x_x202 = kk_integer_from_int(i,kk_context()); /*int*/
  return kk_std_core_int_show(_x_x202, _ctx);
}
...
static inline kk_std_core_types__order kk_std_num_int32_sign(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> order */ 
  bool _match_x192 = 0 < i; /*bool*/;
  if (_match_x192) {
    return kk_std_core_types__new_Gt(_ctx);
  }
  {
    bool _match_x193 = 0 > i; /*bool*/;
    if (_match_x193) {
...
static inline bool kk_std_num_int32_is_odd(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> bool */ 
  int32_t _x_x226 = (i & ((KK_I32(1)))); /*int32*/
  return (_x_x226 == ((KK_I32(1))));
}
...
static inline bool kk_std_num_int32_is_even(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> bool */ 
  int32_t _x_x227 = (i & ((KK_I32(1)))); /*int32*/
  return (_x_x227 == ((KK_I32(0))));
}
...
static inline kk_std_core_types__order kk_std_num_int32_cmp(int32_t x, int32_t y, kk_context_t* _ctx) { /* (x : int32, y : int32) -> order */ 
  bool _match_x190 = (x < y); /*bool*/;
  if (_match_x190) {
    return kk_std_core_types__new_Lt(_ctx);
  }
  {
    bool _match_x191 = (x > y); /*bool*/;
    if (_match_x191) {
      return kk_std_core_types__new_Gt(_ctx);
    }
    {
...
static inline kk_box_t kk_std_num_int32_fold_int32(int32_t n, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (n : int32, init : a, f : (int32, a) -> e a) -> e a */ 
  int32_t _own_x140 = (int32_t)((uint32_t)n - (uint32_t)((KK_I32(1)))); /*int32*/;
  return kk_std_num_int32_range_fs_fold_int32(kk_std_num_int32_zero, _own_x140, init, f, _ctx);
}
...
static inline kk_box_t kk_std_num_int32_fold_while_int32(int32_t n, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (n : int32, init : a, f : (int32, a) -> e maybe<a>) -> e a */ 
  int32_t _x_x272 = (int32_t)((uint32_t)n - (uint32_t)((KK_I32(1)))); /*int32*/
  return kk_std_num_int32_range_fs_fold_while_int32(kk_std_num_int32_zero, _x_x272, init, f, _ctx);
}
...
static inline kk_unit_t kk_std_num_int32_range_fs_for32(int32_t start, int32_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (start : int32, end : int32, action : (int32) -> e ()) -> e () */ 
  kk_std_num_int32_range_fs__lift_for32_2291(action, end, start, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_num_int32_for32(int32_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (n : int32, action : (int32) -> e ()) -> e () */ 
  int32_t end_10029 = (int32_t)((uint32_t)n - (uint32_t)((KK_I32(1)))); /*int32*/;
  kk_std_num_int32_range_fs__lift_for32_2291(action, end_10029, kk_std_num_int32_zero, _ctx); return kk_Unit;
}
...
static inline kk_std_core_types__maybe kk_std_num_int32_range_fs_for_while32(int32_t start, int32_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (start : int32, end : int32, action : (int32) -> e maybe<a>) -> e maybe<a> */ 
  return kk_std_num_int32_range_fs__lift_for_while32_2292(action, end, start, _ctx);
}
...
static inline kk_std_core_types__maybe kk_std_num_int32_for_while32(int32_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (n : int32, action : (int32) -> e maybe<a>) -> e maybe<a> */ 
  int32_t end_10033 = (int32_t)((uint32_t)n - (uint32_t)((KK_I32(1)))); /*int32*/;
  return kk_std_num_int32_range_fs__lift_for_while32_2292(action, end_10033, kk_std_num_int32_zero, _ctx);
}
...
// unrolling of singleton matches of std/num/int32/@unroll-sumacc32@10000

static inline int32_t kk_std_num_int32_sumacc32(kk_std_core_types__list xs, int32_t acc, kk_context_t* _ctx) { /* (xs : list<int32>, acc : int32) -> int32 */ 
  if (kk_std_core_types__is_Nil(xs, _ctx)) {
    return acc;
  }
  {
    return kk_std_num_int32__unroll_sumacc32_10000(xs, acc, _ctx);
  }
}

static inline int32_t kk_std_num_int32_sum32(kk_std_core_types__list xs, kk_context_t* _ctx) { /* (xs : list<int32>) -> int32 */ 
  int32_t acc_10037 = (KK_I32(0)); /*int32*/;
  if (kk_std_core_types__is_Nil(xs, _ctx)) {
    return acc_10037;
  }
  {
    return kk_std_num_int32__unroll_sumacc32_10000(xs, acc_10037, _ctx);
  }
}
