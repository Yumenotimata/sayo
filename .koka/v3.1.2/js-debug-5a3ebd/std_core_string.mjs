...
export function pad_left(s, width, fill) /* (s : string, width : int, fill : ? char) -> string */  {
  ...
  if ($std_core_types._int_le(width,n)) {
    ...
    var s_0_10005 = char_fs_string(_x1);
     
    var n_0_10006 = $std_core_types._int_sub(width,n);
    return $std_core_types._lp__plus__plus__rp_(repeatz(s_0_10005, $std_core_int.ssize__t(n_0_10006)), s);
  }
}
...
export function pad_right(s, width, fill) /* (s : string, width : int, fill : ? char) -> string */  {
  ...
  if ($std_core_types._int_le(width,n)) {
    ...
    var _x1 = (fill !== undefined) ? fill : 0x0020;
    var s_0_10009 = char_fs_string(_x1);
     
    var n_0_10010 = $std_core_types._int_sub(width,n);
    return $std_core_types._lp__plus__plus__rp_(s, repeatz(s_0_10009, $std_core_int.ssize__t(n_0_10010)));
  }
}
